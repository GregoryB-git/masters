...
class OneSignalAnimate {
    public static Animation animateViewByTranslation(View view, float f, float f2, int n, Interpolator interpolator2, Animation.AnimationListener animationListener) {
    ...
    public static ValueAnimator animateViewColor(View view, int n, int n2, int n3, Animator.AnimatorListener animatorListener) {
    ...
    public static Animation animateViewSmallToLarge(View view, int n, Interpolator interpolator2, Animation.AnimationListener animationListener) {
