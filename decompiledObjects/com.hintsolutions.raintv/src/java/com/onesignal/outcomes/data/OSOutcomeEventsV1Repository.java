...
extends OSOutcomeEventsRepository {
    ...
    private final void requestMeasureDirectOutcomeEvent(String string, int n4, OSOutcomeEvent object, OneSignalApiResponseHandler oneSignalApiResponseHandler) {
        try {
            string = ((OSOutcomeEvent)object).toJSONObjectForMeasure().put("app_id", (Object)string).put("device_type", n4).put("direct", true);
            ...
            this.getLogger().error("Generating direct outcome:JSON Failed.", jSONException);
        }
    }

    private final void requestMeasureIndirectOutcomeEvent(String string, int n4, OSOutcomeEvent object, OneSignalApiResponseHandler oneSignalApiResponseHandler) {
        try {
            string = ((OSOutcomeEvent)object).toJSONObjectForMeasure().put("app_id", (Object)string).put("device_type", n4).put("direct", false);
            object = this.getOutcomeEventsService();
            Intrinsics.checkNotNullExpressionValue((Object)string, (String)"jsonObject");
            object.sendOutcomeEvent((JSONObject)string, oneSignalApiResponseHandler);
        }
    ...
    private final void requestMeasureUnattributedOutcomeEvent(String string, int n4, OSOutcomeEvent object, OneSignalApiResponseHandler oneSignalApiResponseHandler) {
        try {
            string = ((OSOutcomeEvent)object).toJSONObjectForMeasure().put("app_id", (Object)string).put("device_type", n4);
            object = this.getOutcomeEventsService();
            Intrinsics.checkNotNullExpressionValue((Object)string, (String)"jsonObject");
            object.sendOutcomeEvent((JSONObject)string, oneSignalApiResponseHandler);
        }
        catch (JSONException jSONException) {
            this.getLogger().error("Generating unattributed outcome:JSON Failed.", jSONException);
        }
    }
    ...
    public void requestMeasureOutcomeEvent(@NotNull String string, int n4, @NotNull OSOutcomeEventParams object, @NotNull OneSignalApiResponseHandler oneSignalApiResponseHandler) {
        ...
        OSOutcomeEvent oSOutcomeEvent = OSOutcomeEvent.fromOutcomeEventParamsV2toOutcomeEventV1(object);
        object = oSOutcomeEvent.getSession();
        int n5 = object == null ? -1 : WhenMappings.$EnumSwitchMapping$0[object.ordinal()];
        if (n5 != 1) {
            if (n5 != 2) {
                if (n5 == 3) {
                    Intrinsics.checkNotNullExpressionValue((Object)oSOutcomeEvent, (String)"event");
                    this.requestMeasureUnattributedOutcomeEvent(string, n4, oSOutcomeEvent, oneSignalApiResponseHandler);
                }
            } else {
                Intrinsics.checkNotNullExpressionValue((Object)oSOutcomeEvent, (String)"event");
                this.requestMeasureIndirectOutcomeEvent(string, n4, oSOutcomeEvent, oneSignalApiResponseHandler);
            }
        } else {
            Intrinsics.checkNotNullExpressionValue((Object)oSOutcomeEvent, (String)"event");
            this.requestMeasureDirectOutcomeEvent(string, n4, oSOutcomeEvent, oneSignalApiResponseHandler);
        }
    }
}
