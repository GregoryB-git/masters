...
VideoViewApi {
    ...
    public NativeSurfaceVideoView(Context context, AttributeSet attributeSet, int n) {
        super(context, attributeSet, n);
        this.setup(context, attributeSet);
    }

    @TargetApi(value=21)
    public NativeSurfaceVideoView(Context context, AttributeSet attributeSet, int n, int n2) {
    ...
    implements SurfaceHolder.Callback {
        public final NativeSurfaceVideoView this$0;
        ...
        public void surfaceChanged(SurfaceHolder surfaceHolder, int n, int n2, int n3) {
            this.this$0.delegate.onSurfaceSizeChanged(n2, n3);
        }
