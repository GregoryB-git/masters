...
implements ClearableSurface {
    ...
    public ResizingSurfaceView(Context context, AttributeSet attributeSet, int n) {
    ...
    @TargetApi(value=21)
    public ResizingSurfaceView(Context context, AttributeSet attributeSet, int n, int n2) {
    ...
    public void clearSurface() {
        try {
            ...
            eGLSurface = eGL10.eglCreateWindowSurface(eGLDisplay, eGLSurface[0], (Object)this, new int[]{12344});
    ...
    public void onMeasure(int n, int n2) {
        ...
        if (point.x > 0 && point.y > 0) {
            ...
            if (n6 == 0x40000000 && n7 == 0x40000000) {
                ...
                point = this.videoSize;
                n = point.y * n4 / point.x;
                if (n7 == Integer.MIN_VALUE && n > n3) {
                    n2 = n4;
                    n = n3;
                } else {
                    n2 = n4;
                ...
                point = this.videoSize;
                n2 = point.x * n3 / point.y;
                if (n6 == Integer.MIN_VALUE && n2 > n4) {
                    n2 = n4;
                    n = n3;
                } else {
                    n = n3;
                ...
                int n10 = point.x;
                int n11 = point.y;
                if (n7 == Integer.MIN_VALUE && n11 > n3) {
                    n2 = n3 * n10 / n11;
                    n = n3;
                } else {
                    n = n11;
    ...
    implements View.OnAttachStateChangeListener {
        public final ResizingSurfaceView this$0;

        private AttachedListener(ResizingSurfaceView resizingSurfaceView) {
            this.this$0 = resizingSurfaceView;
        }

        public /* synthetic */ AttachedListener(ResizingSurfaceView resizingSurfaceView, 1 var2_2) {
    ...
    implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        private GlobalLayoutMatrixListener(ResizingSurfaceView resizingSurfaceView) {
            this.this$0 = resizingSurfaceView;
        }

        public /* synthetic */ GlobalLayoutMatrixListener(ResizingSurfaceView resizingSurfaceView, 1 var2_2) {
            this(resizingSurfaceView);
        }

        public void onGlobalLayout() {
            ResizingSurfaceView resizingSurfaceView = this.this$0;
            resizingSurfaceView.setScaleType(resizingSurfaceView.matrixManager.getCurrentScaleType());
