...
public class FullArticlesAdapter$ViewHolder_ViewBinding
implements Unbinder {
    private FullArticlesAdapter.ViewHolder target;

    @UiThread
    public FullArticlesAdapter$ViewHolder_ViewBinding(FullArticlesAdapter.ViewHolder viewHolder, View view) {
    ...
    @CallSuper
    public void unbind() {
        FullArticlesAdapter.ViewHolder viewHolder = this.target;
        if (viewHolder != null) {
            this.target = null;
