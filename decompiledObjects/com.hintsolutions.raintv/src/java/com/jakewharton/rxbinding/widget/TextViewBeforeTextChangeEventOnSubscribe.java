...
implements Observable.OnSubscribe<TextViewBeforeTextChangeEvent> {
    ...
    public void call(Subscriber<? super TextViewBeforeTextChangeEvent> subscriber) {
        ...
        TextWatcher textWatcher = new TextWatcher(this, subscriber){
            public final TextViewBeforeTextChangeEventOnSubscribe this$0;
            public final Subscriber val$subscriber;
            {
                this.this$0 = textViewBeforeTextChangeEventOnSubscribe;
            ...
            public void beforeTextChanged(CharSequence charSequence, int n4, int n5, int n6) {
                if (!this.val$subscriber.isUnsubscribed()) {
                    this.val$subscriber.onNext((Object)TextViewBeforeTextChangeEvent.create(this.this$0.view, charSequence, n4, n5, n6));
                }
            }
        ...
        subscriber.onNext((Object)TextViewBeforeTextChangeEvent.create((TextView)textWatcher, textWatcher.getText(), 0, 0, 0));
    }
}
