...
implements Observable.OnSubscribe<ViewLayoutChangeEvent> {
    ...
    public void call(Subscriber<? super ViewLayoutChangeEvent> subscriber) {
        ...
        View.OnLayoutChangeListener onLayoutChangeListener = new View.OnLayoutChangeListener(this, subscriber){
            public final ViewLayoutChangeEventOnSubscribe this$0;
            public final Subscriber val$subscriber;
            {
                this.this$0 = viewLayoutChangeEventOnSubscribe;
                this.val$subscriber = subscriber;
            }

            public void onLayoutChange(View view, int n4, int n5, int n6, int n7, int n8, int n9, int n10, int n11) {
                if (!this.val$subscriber.isUnsubscribed()) {
                    this.val$subscriber.onNext((Object)ViewLayoutChangeEvent.create(this.this$0.view, n4, n5, n6, n7, n8, n9, n10, n11));
                }
            }
        };
