...
public final class AFd1lSDK extends AFd1zSDK<Boolean>
{
    ...
    public AFd1lSDK(@NonNull final AFc1xSDK afDebugLog) {
        super(AFd1vSDK.AFInAppEventType, new AFd1vSDK[0], "LoadCachedRequests");
        this.afRDLog = afDebugLog.onAppOpenAttributionNative();
        this.afErrorLog = afDebugLog.AFVersionDeclaration();
        this.afDebugLog = afDebugLog;
    }
    
    public static boolean afInfoLog() {
        return AFd1lSDK.afInfoLog;
    }
    
    private static String valueOf(AFa1rSDK valueOf) {
        final long currentTimeMillis = System.currentTimeMillis();
        final long long1 = Long.parseLong(valueOf.AFInAppEventParameterName, 10);
        valueOf = (AFa1rSDK)valueOf.valueOf;
        try {
            return Uri.parse((String)valueOf).buildUpon().appendQueryParameter("isCachedRequest", "true").appendQueryParameter("timeincache", String.valueOf((currentTimeMillis - long1) / 1000L)).toString();
        }
        catch (Exception ex) {
            AFLogger.afErrorLogForExcManagerOnly("Couldn't parse the uri", ex);
    ...
    public final AFd1ySDK valueOf() {
        for (final AFa1rSDK aFa1rSDK : this.afRDLog.values()) {
            final StringBuilder sb = new StringBuilder("CACHE: resending request: ");
            sb.append(aFa1rSDK.valueOf);
            com.appsflyer.AFLogger.afInfoLog(sb.toString());
            try {
                final AFe1fSDK aFe1fSDK = new AFe1fSDK(valueOf(aFa1rSDK), aFa1rSDK.AFInAppEventType(), aFa1rSDK.AFInAppEventParameterName, aFa1rSDK.AFInAppEventType);
                final AFc1bSDK afErrorLog = this.afErrorLog;
                afErrorLog.AFKeystoreWrapper.execute(new Runnable() {
                    private /* synthetic */ AFd1zSDK AFInAppEventType = new AFd1jSDK(aFe1fSDK, this.afDebugLog);
                ...
                com.appsflyer.AFLogger.afErrorLog("QUEUE: Failed to resend cached request", ex);
            }
        }
        this.AFLogger = Boolean.TRUE;
        AFd1lSDK.afInfoLog = true;
