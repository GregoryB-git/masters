...
public class CrossPromotionHelper
{
    ...
    @NonNull
    private static LinkGenerator AFInAppEventParameterName(@NonNull final Context context, final String afInAppEventType, final String campaign, final Map<String, String> map, final String afInAppEventParameterName) {
        ...
        linkGenerator.AFInAppEventType = afInAppEventType;
    ...
    private static void AFInAppEventType(@NonNull final String s, @NonNull final Context context, final AFf1cSDK aFf1cSDK) {
        final AFa1eSDK value = AFa1eSDK.valueOf();
        value.AFKeystoreWrapper(context);
        final AFc1xSDK afInAppEventType = value.AFInAppEventType();
        final AFd1sSDK aFd1sSDK = new AFd1sSDK(afInAppEventType, s, aFf1cSDK);
        ...
        afVersionDeclaration.AFKeystoreWrapper.execute(new Runnable() {
            private /* synthetic */ AFd1zSDK AFInAppEventType = aFd1sSDK;
    ...
    public static void logAndOpenStore(@NonNull final Context context, final String s, final String s2) {
        logAndOpenStore(context, s, s2, null);
    }
    
    public static void logAndOpenStore(@NonNull final Context context, final String s, final String s2, final Map<String, String> map) {
        final LinkGenerator afInAppEventParameterName = AFInAppEventParameterName(context, s, s2, map, String.format(AFf1bSDK.valueOf, AppsFlyerLib.getInstance().getHostPrefix(), AFa1eSDK.valueOf().getHostName()));
    ...
    public static void logCrossPromoteImpression(@NonNull final Context context, final String s, final String s2) {
        logCrossPromoteImpression(context, s, s2, null);
    }
    
    public static void logCrossPromoteImpression(@NonNull final Context context, final String s, final String s2, final Map<String, String> map) {
        if (AppsFlyerProperties.getInstance().getBoolean("waitForCustomerId", false)) {
        ...
        AFInAppEventType(AFInAppEventParameterName(context, s, s2, map, String.format(CrossPromotionHelper.AFInAppEventType, AppsFlyerLib.getInstance().getHostPrefix(), AFa1eSDK.valueOf().getHostName())).generateLink(), context, null);
    }
    ...
    public static void setUrl(final Map<String, String> map) {
        for (final Map.Entry<String, String> entry : map.entrySet()) {
            ...
            if (n != 0) {
                ...
                CrossPromotionHelper.AFInAppEventType = s;
            }
            else {
                AFf1bSDK.valueOf = s;
            }
