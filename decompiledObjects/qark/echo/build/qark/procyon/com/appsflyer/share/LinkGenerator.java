...
public class LinkGenerator
{
    ...
    private final Map<String, String> afWarnLog;
    private String valueOf;
    private String values;
    
    public LinkGenerator(final String afKeystoreWrapper) {
        this.afWarnLog = new HashMap<String, String>();
    ...
    private Map<String, String> values() {
        ...
        final String afErrorLog = this.afErrorLog;
        if (afErrorLog != null) {
            hashMap.put("af_referrer_uid", afErrorLog);
        }
        final String values = this.values;
        if (values != null) {
            hashMap.put("af_channel", values);
        }
        final String afLogger = this.AFLogger;
        if (afLogger != null) {
            hashMap.put("af_referrer_customer_id", afLogger);
        }
        final String valueOf = this.valueOf;
        if (valueOf != null) {
            hashMap.put("c", valueOf);
        }
        final String afRDLog = this.afRDLog;
        if (afRDLog != null) {
            hashMap.put("af_referrer_name", afRDLog);
        }
        final String afInfoLog = this.afInfoLog;
        if (afInfoLog != null) {
            hashMap.put("af_referrer_image_url", afInfoLog);
        }
        if (this.AFVersionDeclaration != null) {
            final StringBuilder sb = new StringBuilder();
            sb.append(this.AFVersionDeclaration);
            final String afDebugLog = this.afDebugLog;
            if (afDebugLog != null) {
                String str = "";
                this.afDebugLog = afDebugLog.replaceFirst("^[/]", "");
        ...
        for (final Map.Entry<String, String> entry : this.afWarnLog.entrySet()) {
    ...
    public String generateLink() {
        ...
        if (afInAppEventParameterName != null && afInAppEventParameterName.startsWith("http")) {
            ...
            str = String.format(AFf1bSDK.valueOf, AppsFlyerLib.getInstance().getHostPrefix(), AFa1eSDK.valueOf().getHostName());
        }
        sb.append(str);
        ...
        final Map<String, String> values = this.values();
    ...
    @Deprecated
    public void generateLink(final Context context, final CreateOneLinkHttpTask.ResponseListener responseListener) {
        this.generateLink(context, (ResponseListener)new ResponseListener() {
            @Override
            public final void onResponse(final String s) {
                responseListener.onResponse(s);
            }
            
            @Override
            public final void onResponseError(final String s) {
                responseListener.onResponseError(s);
            }
        });
    }
    
    public void generateLink(final Context context, final ResponseListener responseListener) {
        ...
        if (AppsFlyerProperties.getInstance().getBoolean("waitForCustomerId", false)) {
            com.appsflyer.AFLogger.afInfoLog("CustomerUserId not set, generate User Invite Link is disabled", true);
            return;
        }
        AFa1eSDK.valueOf().AFKeystoreWrapper(context);
        final AFc1xSDK afInAppEventType = AFa1eSDK.valueOf().AFInAppEventType();
        final AFd1rSDK aFd1rSDK = new AFd1rSDK(afInAppEventType, UUID.randomUUID(), string, values, afLogger$LogLevel, responseListener);
        ...
        afVersionDeclaration.AFKeystoreWrapper.execute(new Runnable() {
            private /* synthetic */ AFd1zSDK AFInAppEventType = aFd1rSDK;
    ...
    public Map<String, String> getUserParams() {
        return new HashMap<String, String>(this.afWarnLog);
    }
    
    public LinkGenerator setBaseDeeplink(final String afVersionDeclaration) {
        this.AFVersionDeclaration = afVersionDeclaration;
        return this;
    }
    
    public LinkGenerator setBaseURL(String afInAppEventParameterName, final String s, String s2) {
        if (afInAppEventParameterName != null && afInAppEventParameterName.length() > 0) {
            ...
            afInAppEventParameterName = String.format("https://%s/%s", s2, afInAppEventParameterName);
        }
        else {
            afInAppEventParameterName = String.format("https://%s/%s", String.format("%sapp.%s", AppsFlyerLib.getInstance().getHostPrefix(), AFa1eSDK.valueOf().getHostName()), s2);
        }
        this.AFInAppEventParameterName = afInAppEventParameterName;
        return this;
    }
    
    public LinkGenerator setBrandDomain(final String afLogger$LogLevel) {
        this.AFLogger$LogLevel = afLogger$LogLevel;
        return this;
    }
    
    public LinkGenerator setCampaign(final String valueOf) {
    ...
    public LinkGenerator setDeeplinkPath(final String afDebugLog) {
        this.afDebugLog = afDebugLog;
        return this;
    }
    
    public LinkGenerator setReferrerCustomerId(final String afLogger) {
        this.AFLogger = afLogger;
        return this;
    }
    
    public LinkGenerator setReferrerImageURL(final String afInfoLog) {
        this.afInfoLog = afInfoLog;
        return this;
    }
    
    public LinkGenerator setReferrerName(final String afRDLog) {
        this.afRDLog = afRDLog;
        return this;
    }
    
    public LinkGenerator setReferrerUID(final String afErrorLog) {
