...
public final class AFb1wSDK implements AFc1cSDK
{
    ...
    public AFb1wSDK(final AFd1cSDK afInAppEventParameterName, final AFb1gSDK afKeystoreWrapper, final AFe1wSDK valueOf, final AFb1ySDK afInAppEventType, final AFc1oSDK afLogger, final AFe1zSDK afDebugLog, final AFc1bSDK afInfoLog) {
    ...
    public static Map<String, String> AFKeystoreWrapper(Map<String, String> iterator) {
        ...
        while (iterator.hasNext()) {
            ...
            try {
                hashMap.put(URLEncoder.encode(s, "utf-8"), URLEncoder.encode(s2, "utf-8"));
            }
            catch (UnsupportedEncodingException ex) {
                AFLogger.afErrorLogForExcManagerOnly("failed to encode map", ex);
            }
        }
        return hashMap;
    }
    
    private void AFKeystoreWrapper(final AFd1dSDK afErrorLog, final AFd1bSDK aFd1bSDK) {
        synchronized (this.values) {
            this.afErrorLog = afErrorLog;
            // monitorexit(this.values)
            if (aFd1bSDK != null) {
                aFd1bSDK.onRemoteConfigUpdateFinished(afErrorLog);
            }
        }
    }
    
    public final void AFInAppEventParameterName(final AFd1bSDK aFd1bSDK) {
        final AFd1gSDK aFd1gSDK = new AFd1gSDK(this.AFInAppEventParameterName, this.AFKeystoreWrapper, this.valueOf, this.AFInAppEventType, this.AFLogger, this.afDebugLog, "v1", aFd1bSDK);
        final AFc1bSDK afInfoLog = this.afInfoLog;
        afInfoLog.AFKeystoreWrapper.execute(new Runnable() {
            private /* synthetic */ AFd1zSDK AFInAppEventType = aFd1gSDK;
    ...
    @Override
    public final void AFInAppEventParameterName(final AFd1zSDK<?> aFd1gSDK) {
        if (aFd1gSDK instanceof AFd1gSDK) {
            final AFd1gSDK aFd1gSDK2 = aFd1gSDK;
            synchronized (this.values) {
                this.afRDLog = null;
                // monitorexit(this.values)
                this.AFKeystoreWrapper(AFd1dSDK.AFInAppEventParameterName, aFd1gSDK2.afInfoLog);
            }
        }
    }
    ...
    public final void AFInAppEventType(final AFd1zSDK<?> aFd1zSDK, final AFd1ySDK aFd1ySDK) {
        if (aFd1zSDK instanceof AFd1gSDK) {
            final AFd1gSDK aFd1gSDK = (AFd1gSDK)aFd1zSDK;
            AFd1dSDK aFd1dSDK;
            if ((aFd1dSDK = aFd1gSDK.AFLogger) == null) {
                com.appsflyer.AFLogger.afWarnLog("CFG: update RC returned null result, something went wrong!");
                aFd1dSDK = AFd1dSDK.AFInAppEventParameterName;
            }
            if (aFd1dSDK != AFd1dSDK.AFKeystoreWrapper) {
                final AFf1zSDK afRDLog = aFd1gSDK.afRDLog;
                synchronized (this.values) {
                    this.afRDLog = afRDLog;
                }
            }
            this.AFKeystoreWrapper(aFd1dSDK, aFd1gSDK.afInfoLog);
        }
    }
    
    public final AFf1zSDK AFKeystoreWrapper() {
        synchronized (this.values) {
            final AFf1zSDK afRDLog = this.afRDLog;
            this.afRDLog = null;
            return afRDLog;
        }
    }
