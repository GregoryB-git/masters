...
public interface n0
{
    ...
    void B(final int p0, final List p1, final boolean p2);
    ...
    void J(final int p0, final List p1, final Z p2);
    
    void K(final int p0, final List p1, final Z p2);
    
    void L(final int p0, final Object p1, final Z p2);
    
    void M(final int p0, final f p1);
    
    void N(final int p0, final Object p1, final Z p2);
    
    void O(final int p0, final D.a p1, final Map p2);
    ...
    void f(final int p0, final Object p1);
    ...
    void j(final int p0, final List p1, final boolean p2);
    
    void k(final int p0, final List p1, final boolean p2);
    
    void l(final int p0, final int p1);
    
    void m(final int p0, final double p1);
    
    void n(final int p0, final long p1);
    
    void o(final int p0, final List p1, final boolean p2);
    
    void p(final int p0, final List p1, final boolean p2);
    
    void q(final int p0, final List p1, final boolean p2);
    
    void r(final int p0, final List p1, final boolean p2);
    ...
    void x(final int p0, final float p1);
    
    void y(final int p0, final List p1);
