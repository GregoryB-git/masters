...
public abstract class p0
{
    ...
    public static final class e extends b
    {
        ...
        public static int f(final byte[] array, long n, int u) {
            final int g = g(array, n, u);
            u -= g;
            n += g;
            while (true) {
                final int n2 = 0;
                ...
                if (u < -32) {
                    ...
                    if (n5 < 2) {
                        return h(array, u, n4, n5);
                    }
                    final int n7 = n3 - 3;
                    final byte u2 = o0.u(array, n4);
                    if (u2 > -65 || (u == -32 && u2 < -96) || (u == -19 && u2 >= -96)) {
                        break;
                    }
                    n = n4 + 2L;
                    u = n7;
                    if (o0.u(array, 1L + n4) > -65) {
                        break;
                    }
                    continue;
                }
                    ...
                    final int n8 = n3 - 4;
                    final byte u3 = o0.u(array, n4);
                    if (u3 > -65 || (u << 28) + (u3 + 112) >> 30 != 0 || o0.u(array, 1L + n4) > -65) {
                        return -1;
                    }
                    n = n4 + 3L;
                    u = n8;
                    if (o0.u(array, 2L + n4) > -65) {
                        return -1;
                    }
                    continue;
                }
        ...
        public static int g(final byte[] array, long n, final int n2) {
            ...
            while (true) {
                ...
                if ((o0.A(array, o0.h + n) & 0x8080808080808080L) != 0x0L) {
                    i = n6;
                    n8 = n;
                    break;
                }
        ...
        public static int h(final byte[] array, final int n, final long n2, final int n3) {
            ...
            if (n3 == 1) {
                return j(n, o0.u(array, n2));
            }
            if (n3 == 2) {
                return k(n, o0.u(array, n2), o0.u(array, n2 + 1L));
            }
            throw new AssertionError();
        }
        
        @Override
        public String a(final byte[] array, final int n, final int length) {
            final Charset b = z.b;
                ...
                Label_0477: {
                    if (char1 < '\u0080' && lng < n3) {
                        ...
                        if (char1 < '\u0800' && lng <= n3 - 2L) {
                            o0.K(array, lng, (byte)(char1 >>> 6 | 0x3C0));
                            n6 = lng + 2L;
                            o0.K(array, lng + n4, (byte)((char1 & '?') | 0x80));
                        }
                        else if ((char1 < '\ud800' || '\udfff' < char1) && lng <= n3 - 3L) {
                            o0.K(array, lng, (byte)(char1 >>> 12 | 0x1E0));
                            o0.K(array, lng + 1L, (byte)((char1 >>> 6 & 0x3F) | 0x80));
                            n6 = lng + 3L;
                            o0.K(array, lng + 2L, (byte)((char1 & '?') | 0x80));
                        }
                        else {
                            if (lng <= n3 - 4L) {
                                n = i + 1;
                                if (n != length) {
                                    ...
                                    if (Character.isSurrogatePair(char1, char2)) {
                                        ...
                                        n4 = 1L;
                                        o0.K(array, lng, (byte)(i >>> 18 | 0xF0));
                                        o0.K(array, lng + 1L, (byte)((i >>> 12 & 0x3F) | 0x80));
                                        o0.K(array, lng + 2L, (byte)((i >>> 6 & 0x3F) | 0x80));
                                        n6 = lng + 4L;
                                        o0.K(array, lng + 3L, (byte)((i & 0x3F) | 0x80));
                                        i = n;
                                        break Label_0477;
                                    }
                                    i = n;
        ...
        @Override
        public int d(int u, final byte[] array, int u2, int u3) {
            final int n = 0;
