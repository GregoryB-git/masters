...
public abstract class M
{
    ...
    public static void e(final K k, final StringBuilder sb, final int n) {
        ...
        final Method[] declaredMethods = k.getClass().getDeclaredMethods();
    ...
    Label_0459_Outer:
        while (iterator.hasNext()) {
            ...
            if (substring.endsWith("List") && !substring.endsWith("OrBuilderList") && !substring.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    d(sb, n, substring.substring(0, substring.length() - 4), r.F(method2, k, new Object[0]));
                    beginIndex = 3;
            ...
            while (true) {
                Label_0464: {
                    ...
                    d(sb, n, substring.substring(0, substring.length() - 3), r.F(method3, k, new Object[0]));
                    beginIndex = 3;
                    continue Label_0459_Outer;
                }
                ...
                Label_0504: {
                    if (set.contains(sb2.toString())) {
                        ...
                        if (method4 != null) {
                            final Object f = r.F(method4, k, new Object[0]);
                            if (method5 == null) {
                                if (b(f)) {
                                    continue;
                                }
                            }
                            else if (!(boolean)r.F(method5, k, new Object[0])) {
                                continue;
                            }
                            d(sb, n, substring, f);
                        }
        ...
        final h0 unknownFields = ((r)k).unknownFields;
        if (unknownFields != null) {
            unknownFields.l(sb, n);
        }
    }
    
    public static String f(final K k, final String str) {
        final StringBuilder sb = new StringBuilder();
        sb.append("# ");
        sb.append(str);
        e(k, sb, 0);
