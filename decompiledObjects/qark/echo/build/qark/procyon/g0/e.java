...
public abstract class e
{
    ...
    static {
        ...
        final HashMap<String, Integer> d2 = new HashMap<String, Integer>();
    ...
    public static int a(final String s, final boolean b) {
        g0.a.a(TextUtils.isEmpty((CharSequence)s) ^ true);
        ...
        if (replace.charAt(0) != '#') {
            if (replace.startsWith("rgba")) {
                ...
                if (matcher.matches()) {
                    int int1;
                    if (b) {
                        int1 = (int)(Float.parseFloat((String)g0.a.e(matcher.group(4))) * 255.0f);
                    }
                    else {
                        int1 = Integer.parseInt((String)g0.a.e(matcher.group(4)), 10);
                    }
                    return Color.argb(int1, Integer.parseInt((String)g0.a.e(matcher.group(1)), 10), Integer.parseInt((String)g0.a.e(matcher.group(2)), 10), Integer.parseInt((String)g0.a.e(matcher.group(3)), 10));
                }
            }
            else if (replace.startsWith("rgb")) {
                final Matcher matcher2 = e.a.matcher(replace);
                if (matcher2.matches()) {
                    return Color.rgb(Integer.parseInt((String)g0.a.e(matcher2.group(1)), 10), Integer.parseInt((String)g0.a.e(matcher2.group(2)), 10), Integer.parseInt((String)g0.a.e(matcher2.group(3)), 10));
                }
            }
            else {
                final Integer n = e.d.get(W2.c.e(replace));
                if (n != null) {
                    return n;
                }
            }
        ...
        final int n2 = (int)Long.parseLong(replace.substring(1), 16);
        if (replace.length() == 7) {
            return 0xFF000000 | n2;
        }
        if (replace.length() == 9) {
            return (n2 & 0xFF) << 24 | n2 >>> 8;
        }
        throw new IllegalArgumentException();
    }
