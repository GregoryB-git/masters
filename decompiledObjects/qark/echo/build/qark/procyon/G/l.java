...
public abstract class l implements Spannable
{
    public static final class a
    {
        ...
        public a(final TextPaint a, final TextDirectionHeuristic b, final int c, final int d) {
        ...
        public boolean a(final l.a a) {
            ...
            if (sdk_INT >= 24) {
                if (!E.j.a(a.a(this.a), (Object)a.a(a.e()))) {
                    return false;
                }
            }
            else if (!((Paint)this.a).getTextLocale().equals(((Paint)a.e()).getTextLocale())) {
                return false;
            }
        ...
        public int hashCode() {
            if (Build$VERSION.SDK_INT >= 24) {
                return H.c.b(((Paint)this.a).getTextSize(), ((Paint)this.a).getTextScaleX(), ((Paint)this.a).getTextSkewX(), ((Paint)this.a).getLetterSpacing(), ((Paint)this.a).getFlags(), G.a.a(this.a), ((Paint)this.a).getTypeface(), ((Paint)this.a).isElegantTextHeight(), this.b, this.c, this.d);
            }
            return H.c.b(((Paint)this.a).getTextSize(), ((Paint)this.a).getTextScaleX(), ((Paint)this.a).getTextSkewX(), ((Paint)this.a).getLetterSpacing(), ((Paint)this.a).getFlags(), ((Paint)this.a).getTextLocale(), ((Paint)this.a).getTypeface(), ((Paint)this.a).isElegantTextHeight(), this.b, this.c, this.d);
        }
        ...
        public String toString() {
            ...
            if (sdk_INT >= 24) {
                ...
                sb7 = new StringBuilder();
                sb7.append(", textLocale=");
                obj = ((Paint)this.a).getTextLocale();
            }
            sb7.append(obj);
            sb.append(sb7.toString());
            final StringBuilder sb8 = new StringBuilder();
            sb8.append(", typeface=");
            sb8.append(((Paint)this.a).getTypeface());
            sb.append(sb8.toString());
            if (sdk_INT >= 26) {
                final StringBuilder sb9 = new StringBuilder();
                sb9.append(", variationSettings=");
                sb9.append(G.c.a(this.a));
