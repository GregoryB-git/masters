...
public interface s0
{
    ...
    void J(final int p0, final g p1);
    
    void K(final int p0, final Object p1, final e0 p2);
    
    void L(final int p0, final List p1, final e0 p2);
    
    void M(final int p0, final List p1, final e0 p2);
    
    void N(final int p0, final H.a p1, final Map p2);
    
    void O(final int p0, final Object p1, final e0 p2);
