...
public abstract class h0 extends AbstractMap
{
    ...
    public static /* synthetic */ List b(final h0 h0) {
        return h0.p;
    }
    
    public static /* synthetic */ Map c(final h0 h0) {
        return h0.q;
    }
    
    public static /* synthetic */ Map e(final h0 h0) {
        return h0.t;
    }
    
    public static h0 q(final int n) {
        return new h0(n) {
            @Override
            public void p() {
                if (!this.o()) {
    ...
    public boolean equals(final Object o) {
        ...
        final int k = this.k();
        if (k != h0.k()) {
            return this.entrySet().equals(h0.entrySet());
        }
        for (int i = 0; i < k; ++i) {
            if (!this.j(i).equals(h0.j(i))) {
                return false;
            }
        }
        return k == size || this.q.equals(h0.q);
    }
    ...
    public class b implements Iterator
    {
        ...
        public b() {
            this.o = h0.b(h0.this).size();
        }
        
        public final Iterator b() {
            if (this.p == null) {
                this.p = h0.e(h0.this).entrySet().iterator();
            }
            return this.p;
        }
        ...
        public boolean hasNext() {
            final int o = this.o;
            return (o > 0 && o <= h0.b(h0.this).size()) || this.b().hasNext();
        }
    ...
    public class e implements Entry, Comparable
    {
        ...
        public e(final h0 h0, final Entry entry) {
            this(h0, entry.getKey(), entry.getValue());
        }
    ...
    public class f implements Iterator
    {
        ...
        public final Iterator b() {
            if (this.q == null) {
                this.q = h0.c(h0.this).entrySet().iterator();
            }
            return this.q;
        }
        ...
        public Entry d() {
            ...
            this.o = o;
            Map.Entry entry;
            if (o < h0.b(h0.this).size()) {
                entry = h0.b(h0.this).get(this.o);
            }
            else {
                entry = this.b().next();
            }
        ...
        public boolean hasNext() {
            final int o = this.o;
            boolean b = true;
            if (o + 1 >= h0.b(h0.this).size()) {
                if (!h0.c(h0.this).isEmpty() && this.b().hasNext()) {
                    return true;
                }
                b = false;
            }
    ...
    public class g extends AbstractSet
    {
        public boolean a(final Entry entry) {
            if (!this.contains(entry)) {
                h0.this.r(entry.getKey(), entry.getValue());
                return true;
            }
            return false;
        }
        ...
        public boolean contains(Object value) {
            ...
            value = h0.this.get(entry.getKey());
