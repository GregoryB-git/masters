...
public final class i extends d3.c
{
    ...
    public i(final int a, final int b, final int c, final c d) {
        this.a = a;
        this.b = b;
        this.c = c;
        this.d = d;
    ...
    public static final class b
    {
        ...
        public i a() {
            ...
            if (this.c != null) {
                return new i(a, this.b, this.c, this.d, null);
            }
        ...
        public b b(final int n) {
            if (n != 12 && n != 16) {
                throw new GeneralSecurityException(String.format("Invalid IV size in bytes %d; acceptable values have 12 or 16 bytes", n));
            }
            this.b = n;
            return this;
        }
        ...
        public b d(final int n) {
            ...
            throw new GeneralSecurityException(String.format("Invalid tag size in bytes %d; value must be at most 16 bytes", n));
        }
