...
{
    public static int i(final FontStyle fontStyle, final FontStyle fontStyle2) {
    ...
    public final Font h(final FontFamily fontFamily, int i) {
        int n;
        if ((i & 0x1) != 0x0) {
            n = 700;
        }
        ...
        int j = i(fontStyle, font.getStyle());
        Font font2;
        int k;
        int n3;
        for (i = n2; i < fontFamily.getSize(); ++i, j = n3) {
            font2 = fontFamily.getFont(i);
            k = i(fontStyle, font2.getStyle());
            if (k < (n3 = j)) {
                font = font2;
                n3 = k;
            }
