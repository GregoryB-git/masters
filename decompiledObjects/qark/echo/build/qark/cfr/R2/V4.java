...
implements Runnable {
    ...
    public V4(D4 d42, AtomicReference atomicReference, String string2, String string3, String string4, W5 w52) {
        this.t = d42;
    ...
    public final void run() {
        ...
        if (TextUtils.isEmpty((CharSequence)this.p)) {
            n.i(this.s);
            var2_6 = this.o;
            var1_2 = var1_2.V0(this.q, this.r, this.s);
        } else {
            var2_6 = this.o;
            var1_2 = var1_2.K0(this.p, this.q, this.r);
        }
        ...
        ** GOTO lbl34
        ...
        {
            this.t.j().G().d("(legacy) Failed to get conditional properties; remote exception", Y1.v(this.p), this.q, (Object)var1_5);
            this.o.set((Object)Collections.emptyList());
        }
        {
            var1_2 = this.o;
