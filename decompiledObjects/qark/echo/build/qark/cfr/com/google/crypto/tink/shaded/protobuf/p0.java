...
public abstract class p0 {
    ...
    static {
        b b8 = e.e() && !com.google.crypto.tink.shaded.protobuf.d.c() ? new e() : new c();
        a = b8;
    }
    ...
    public static int l(byte[] arrby, int n8, int n9) {
        ...
        if ((n9 -= n8) != 0) {
            if (n9 != 1) {
                if (n9 == 2) {
                    return p0.k(by, arrby[n8], arrby[n8 + 1]);
                }
                throw new AssertionError();
            }
            return p0.j(by, arrby[n8]);
        }
        return p0.i(by);
    }
    ...
    extends b {
            ...
            do {
                ...
                if (n8 < -16) {
                    ...
                    if (!(n10 > -65 || n8 == -32 && n10 < -96 || n8 == -19 && n10 >= -96)) {
                        l8 = l9 + 2L;
                        n8 = n9;
                        if (o0.u(arrby, 1L + l9) <= -65) continue;
                    }
                    return -1;
                }
                if (n10 < 3) {
                ...
                n9 -= 4;
                n10 = o0.u(arrby, l9);
                if (n10 > -65 || (n8 << 28) + (n10 + 112) >> 30 != 0 || o0.u(arrby, 1L + l9) > -65) break;
                l8 = l9 + 3L;
                n8 = n9;
                if (o0.u(arrby, 2L + l9) > -65) break;
            } while (true);
            return -1;
        }
        ...
        public static int g(byte[] arrby, long l8, int n8) {
            ...
            do {
                ...
                l9 = l8;
                if (n11 > n8) break;
                if ((o0.A(arrby, o0.h + l8) & -9187201950435737472L) != 0L) {
                    n10 = n9;
                    l9 = l8;
                    break;
                }
        ...
        public static int h(byte[] arrby, int n8, long l8, int n9) {
            if (n9 != 0) {
                if (n9 != 1) {
                    if (n9 == 2) {
                        return p0.k(n8, o0.u(arrby, l8), o0.u(arrby, l8 + 1L));
                    }
                    throw new AssertionError();
                }
                return p0.j(n8, o0.u(arrby, l8));
            }
            return p0.i(n8);
        }
        ...
        public String a(byte[] arrby, int n8, int n9) {
            Charset charset = z.b;
            String string2 = new String(arrby, n8, n9, charset);
            if (!string2.contains((CharSequence)"\ufffd")) {
                return string2;
            }
            if (Arrays.equals((byte[])string2.getBytes(charset), (byte[])Arrays.copyOfRange((byte[])arrby, (int)n8, (int)(n9 + n8)))) {
                return string2;
            }
            throw A.d();
        }
            ...
            block12 : {
                ...
                if (var7_7 <= var4_4 && var2_2.length - var4_4 >= var3_3) {
                    ...
                    do {
                        ...
                        o0.K((byte[])var2_2, var8_5, (byte)var3_3);
                        ++var4_4;
                        var8_5 = 1L + var8_5;
                    } while (true);
                    var3_3 = var4_4;
                    ...
                    block14 : {
                        block15 : {
                            block13 : {
                                ...
                                o0.K((byte[])var2_2, var14_11, (byte)var5_12);
                                var16_14 = var10_10;
                            ...
                            o0.K((byte[])var2_2, var14_11, (byte)(var5_12 >>> 6 | 960));
                            var8_5 = var14_11 + 2L;
                            o0.K((byte[])var2_2, var14_11 + var10_10, (byte)(var5_12 & 63 | 128));
                            ** GOTO lbl46
                        }
                        if ((var5_12 < '\ud800' || '\udfff' < var5_12) && var14_11 <= var12_6 - 3L) {
                            o0.K((byte[])var2_2, var14_11, (byte)(var5_12 >>> 12 | 480));
                            o0.K((byte[])var2_2, var14_11 + 1L, (byte)(var5_12 >>> 6 & 63 | 128));
                            var8_5 = var14_11 + 3L;
                            o0.K((byte[])var2_2, var14_11 + 2L, (byte)(var5_12 & 63 | 128));
lbl46: // 2 sources:
                            var10_10 = 1L;
                        } else {
                            ...
                            var10_10 = 1L;
                            o0.K((byte[])var2_2, var14_11, (byte)(var3_3 >>> 18 | 240));
                            o0.K((byte[])var2_2, var14_11 + 1L, (byte)(var3_3 >>> 12 & 63 | 128));
                            o0.K((byte[])var2_2, var14_11 + 2L, (byte)(var3_3 >>> 6 & 63 | 128));
                            var8_5 = var14_11 + 4L;
                            o0.K((byte[])var2_2, var14_11 + 3L, (byte)(var3_3 & 63 | 128));
                            var3_3 = var4_4;
                        }
                    }
                    ++var3_3;
        ...
        public int d(int n8, byte[] arrby, int n9, int n10) {
            block20 : {
                ...
                block19 : {
                    ...
                    if (n10 > -65) return -1;
                    l8 = l10 + 1L;
                    if (o0.u(arrby, l10) > -65) break block20;
                }
                l10 = l8;
                return e.f(arrby, l10, (int)(l9 - l10));
            }
