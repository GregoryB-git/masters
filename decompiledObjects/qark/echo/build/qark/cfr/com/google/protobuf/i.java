...
implements n0 {
    ...
    public i(h h8) {
        this.a = h8 = (h)t.b(h8, "output");
        h8.a = this;
    }

    public static i P(h h8) {
        i i8 = h8.a;
        if (i8 != null) {
            return i8;
        }
    ...
    public void I(int n8, List list) {
        for (int i8 = 0; i8 < list.size(); ++i8) {
            this.a.f0(n8, (f)list.get(i8));
        }
    }

    @Override
    public void J(int n8, List list, Z z8) {
        for (int i8 = 0; i8 < list.size(); ++i8) {
            this.N(n8, list.get(i8), z8);
        }
    }

    @Override
    public void K(int n8, List list, Z z8) {
        for (int i8 = 0; i8 < list.size(); ++i8) {
            this.L(n8, list.get(i8), z8);
        }
    }

    @Override
    public void L(int n8, Object object, Z z8) {
        this.a.s0(n8, (K)object, z8);
    }

    @Override
    public void M(int n8, f f8) {
        this.a.f0(n8, f8);
    }

    @Override
    public void N(int n8, Object object, Z z8) {
        this.a.z0(n8, (K)object, z8);
    }

    @Override
    public void O(int n8, D.a a8, Map map) {
        if (this.a.W()) {
            this.T(n8, a8, map);
            return;
        }
        for (Map.Entry entry : map.entrySet()) {
            this.a.N0(n8, 2);
            this.a.P0(D.b(a8, entry.getKey(), entry.getValue()));
            D.e(this.a, a8, entry.getKey(), entry.getValue());
        }
    }

    public final void Q(int n8, boolean bl, Object object, D.a a8) {
        this.a.N0(n8, 2);
        this.a.P0(D.b(a8, bl, object));
        D.e(this.a, a8, bl, object);
    }

    public final void R(int n8, D.a a8, Map map) {
        int n9 = map.size();
        int[] arrn = new int[n9];
        ...
        for (n11 = n10; n11 < n9; ++n11) {
            ...
            this.a.N0(n8, 2);
            this.a.P0(D.b(a8, n10, object));
            D.e(this.a, a8, n10, object);
        }
    }

    public final void S(int n8, D.a a8, Map map) {
        int n9 = map.size();
        ...
        for (n11 = n10; n11 < n9; ++n11) {
            ...
            this.a.N0(n8, 2);
            this.a.P0(D.b(a8, l8, object));
            D.e(this.a, a8, l8, object);
        }
    }

    public final void T(int n8, D.a a8, Map object) {
    ...
    public final void U(int n8, D.a a8, Map map) {
        int n9 = map.size();
        ...
        for (n11 = n10; n11 < n9; ++n11) {
            ...
            this.a.N0(n8, 2);
            this.a.P0(D.b(a8, object, object2));
            D.e(this.a, a8, object, object2);
        }
    }
    ...
    public void b(int n8, List list, boolean bl) {
        ...
        if (bl) {
            ...
            n9 = n8 = 0;
            while (n8 < list.size()) {
                n9 += h.r(((Float)list.get(n8)).floatValue());
                ++n8;
            }
            this.a.P0(n9);
            for (n8 = n10; n8 < list.size(); ++n8) {
    ...
    public final void f(int n8, Object object) {
        if (object instanceof f) {
            this.a.C0(n8, (f)object);
            return;
        }
        this.a.B0(n8, (K)object);
    }
