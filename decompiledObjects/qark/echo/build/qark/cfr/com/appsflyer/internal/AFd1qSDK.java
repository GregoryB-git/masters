...
extends AFd1pSDK {
    public AFd1qSDK(@NonNull Map<String, Object> object, PurchaseHandler.PurchaseValidationCallback purchaseValidationCallback, @NonNull AFc1xSDK aFc1xSDK) {
        super(AFd1vSDK.getLevel, new AFd1vSDK[]{AFd1vSDK.values}, aFc1xSDK, null, (Map<String, Object>)object, purchaseValidationCallback);
    ...
    public final AFc1qSDK<String> values(@NonNull String aFc1qSDK) {
        aFc1qSDK = this.AFLogger.AFInAppEventParameterName(this.afWarnLog(), (String)((Object)aFc1qSDK), this.afErrorLogForExcManagerOnly());
        if (aFc1qSDK != null) {
