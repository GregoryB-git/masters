...
extends d3.c {
    ...
    public i(int n8, int n9, int n10, c c8) {
        this.a = n8;
        this.b = n9;
        this.c = n10;
        this.d = c8;
    ...
    public /* synthetic */ i(int n8, int n9, int n10, c c8,  a8) {
        this(n8, n9, n10, c8);
    }
    ...
    public String toString() {
        ...
        stringBuilder.append("AesEax Parameters (variant: ");
    ...
    public static final class b {
        ...
        public i a() {
            ...
            if (n8 != null) {
                if (this.b != null) {
                    if (this.d != null) {
                        if (this.c != null) {
                            return new i(n8, this.b, this.c, this.d, null);
                        }
        ...
        public b b(int n8) {
            if (n8 != 12 && n8 != 16) {
                throw new GeneralSecurityException(String.format((String)"Invalid IV size in bytes %d; acceptable values have 12 or 16 bytes", (Object[])new Object[]{n8}));
            }
            this.b = n8;
            return this;
        }
        ...
        public b d(int n8) {
            ...
            throw new GeneralSecurityException(String.format((String)"Invalid tag size in bytes %d; value must be at most 16 bytes", (Object[])new Object[]{n8}));
        }
