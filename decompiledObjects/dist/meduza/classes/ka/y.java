  ...
  implements t0
{
  ...
  private a0.d<a> aggregations_ = e1.d;
  ...
  public static void G(y paramy, z paramz)
  {
    paramy.getClass();
    paramz.getClass();
    queryType_ = paramz;
  ...
  public static void H(y paramy, ArrayList paramArrayList)
  {
    a0.d locald = aggregations_;
    if (!locald.g()) {
      aggregations_ = w.A(locald);
    }
    a.k(paramArrayList, aggregations_);
  }
  ...
  public final Object t(w.f paramf)
  {
    ...
    case 3: 
      return new y();
    case 2: 
      return new f1(DEFAULT_INSTANCE, "\000\002\001\000\001\003\002\000\001\000\001<\000\003\033", new Object[] { "queryType_", "queryTypeCase_", z.class, "aggregations_", a.class });
    case 1: 
      return null;
    }
