...
public class k
{
  ...
  static
  {
    ...
    try
    {
      localClassLoader.loadClass("com.android.org.conscrypt.OpenSSLSocketImpl");
    }
    catch (ClassNotFoundException localClassNotFoundException1)
    {
      b.log(Level.FINE, "Unable to find Conscrypt. Skipping", localClassNotFoundException1);
    }
    int i;
    try
    {
      localClassLoader.loadClass("org.apache.harmony.xnet.provider.jsse.OpenSSLSocketImpl");
      i = 1;
    }
    catch (ClassNotFoundException localClassNotFoundException2)
    {
      b.log(Level.FINE, "Unable to find any OpenSSLSocketImpl. Skipping", localClassNotFoundException2);
      i = 0;
    }
    Object localObject;
    if (i != 0) {
  ...
  public static boolean c(String paramString)
  {
    ...
    {
      boolean bool;
      if (v0.a(paramString).getAuthority().indexOf('@') == -1) {
        bool = true;
      } else {
        bool = false;
      }
      b.n(paramString, "Userinfo must not be present on authority: '%s'", bool);
      return true;
    }
  ...
  public void a(SSLSocket paramSSLSocket, String paramString, List<j> paramList)
  {
    a.c(paramSSLSocket, paramString, paramList);
  }
  
  public String b(SSLSocket paramSSLSocket)
  {
    return a.d(paramSSLSocket);
  }
  
  public String d(SSLSocket paramSSLSocket, String paramString, List<j> paramList)
  {
    if (paramList != null) {
      a(paramSSLSocket, paramString, paramList);
    }
    try
    {
      paramSSLSocket.startHandshake();
      paramString = b(paramSSLSocket);
      if (paramString != null) {
        return paramString;
      }
      ...
      localStringBuilder.append("TLS ALPN negotiation failed with protocols: ");
