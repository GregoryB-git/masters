...
public final class u1
{
  ...
  public static String a(int paramInt1, ByteBuffer paramByteBuffer, int paramInt2)
  {
    b localb = a;
    localb.getClass();
    if (paramByteBuffer.hasArray())
    {
      ...
      paramByteBuffer = localb.a(paramByteBuffer.array(), i + paramInt1, paramInt2);
    }
    else if (paramByteBuffer.isDirect())
    {
      paramByteBuffer = localb.c(paramInt1, paramByteBuffer, paramInt2);
    }
    else
    {
      paramByteBuffer = b.b(paramInt1, paramByteBuffer, paramInt2);
    }
  ...
  public static boolean e(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    b localb = a;
    boolean bool = false;
    if (localb.e(0, paramArrayOfByte, paramInt1, paramInt2) == 0) {
      bool = true;
    }
    return bool;
  }
