...
public class l1<K extends Comparable<K>, V>
  extends AbstractMap<K, V>
{
  public final int a;
  public List<l1<K, V>.b> b;
  public Map<K, V> c;
  public boolean d;
  public volatile l1<K, V>.d e;
  public Map<K, V> f;
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    int i = size();
    if (i != ((l1)paramObject).size()) {
      return false;
    }
    int j = e();
    if (j != ((l1)paramObject).e()) {
      return entrySet().equals(((l1)paramObject).entrySet());
    }
    for (int k = 0; k < j; k++) {
      if (!d(k).equals(((l1)paramObject).d(k))) {
        return false;
      }
    }
    if (j != i) {
