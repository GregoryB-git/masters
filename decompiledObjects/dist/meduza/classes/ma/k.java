  ...
  extends e
{
  ...
  public static final boolean d = t1.e;
  public l b;
  ...
  @Deprecated
  public static int C(int paramInt, s0 params0, i1 parami1)
  {
    paramInt = N(paramInt);
    return ((a)params0).m(parami1) + paramInt * 2;
  }
  ...
  public static int G(f0 paramf0)
  {
    int i;
    if (b != null) {
      i = b.size();
  ...
  public static int w(int paramInt, h paramh)
  {
    paramInt = N(paramInt);
    int i = paramh.size();
  ...
  public abstract void W(int paramInt, h paramh);
  
  public abstract void X(h paramh);
  ...
  public abstract void e0(int paramInt, s0 params0, i1 parami1);
  
  public abstract void f0(s0 params0);
  
  public abstract void g0(int paramInt, s0 params0);
  
  public abstract void h0(int paramInt, h paramh);
