...
public class a
{
  ...
  public void d(View paramView, f0.b paramb)
  {
  ...
  {
    Object localObject1 = (List)paramView.getTag(2131362032);
    ...
    {
      localObject1 = (b.a)((List)localObject2).get(i);
    ...
    boolean bool2 = a.performAccessibilityAction(paramView, paramInt, paramBundle);
    boolean bool3 = bool2;
    if (!bool2)
    {
      bool3 = bool2;
      if (paramInt == 2131361798)
      {
        bool3 = bool2;
        if (paramBundle != null)
        {
          paramInt = paramBundle.getInt("ACCESSIBILITY_CLICKABLE_SPAN_ID", -1);
          paramBundle = (SparseArray)paramView.getTag(2131362033);
          bool3 = bool1;
          if (paramBundle != null)
          {
