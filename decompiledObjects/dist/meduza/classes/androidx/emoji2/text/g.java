  ...
  extends d.c
{
  ...
  public g(Context paramContext, b0.g paramg)
  {
    super(new b(paramContext, paramg));
  }
    ...
    implements d.g
  {
    ...
    public b(Context paramContext, b0.g paramg)
    {
    ...
    public final n d()
    {
      try
      {
        ...
        locala.getClass();
        localObject = e.a(localContext, (b0.g)localObject);
        if (a == 0)
        {
          localObject = b;
