  ...
  implements e0
{
  ...
  {
    paramString = g.d("ExoPlayer:Loader:", paramString);
    int i = v5.e0.a;
    a = Executors.newSingleThreadExecutor(new a(paramString, 1));
  }
  ...
  public final void e(e parame)
  {
    ...
    if (parame != null) {
      a.execute(new f(parame));
    }
    a.shutdown();
  }
  
  public final <T extends d> long f(T paramT, a<T> parama, int paramInt)
  {
    Looper localLooper = Looper.myLooper();
    b.K(localLooper);
    c = null;
    long l = SystemClock.elapsedRealtime();
    new c(localLooper, paramT, parama, paramInt, l).b(0L);
    return l;
  }
  
  public static abstract interface a<T extends d0.d>
  {
    public abstract void k(T paramT, long paramLong1, long paramLong2, boolean paramBoolean);
    
    public abstract void p(T paramT, long paramLong1, long paramLong2);
    
    public abstract d0.b u(T paramT, long paramLong1, long paramLong2, IOException paramIOException, int paramInt);
  }
  ...
  public final class c<T extends d0.d>
    extends Handler
    implements Runnable
  {
    public final int a;
    ...
    public c(T paramT, d0.a<T> parama, int paramInt, long paramLong)
    {
      super();
      b = parama;
      d = paramInt;
