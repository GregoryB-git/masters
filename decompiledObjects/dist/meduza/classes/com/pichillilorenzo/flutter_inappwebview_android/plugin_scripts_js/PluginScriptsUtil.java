...
public class PluginScriptsUtil
{
  ...
  public static final PluginScript CHECK_GLOBAL_KEY_DOWN_EVENT_TO_HIDE_CONTEXT_MENU_JS_PLUGIN_SCRIPT = new PluginScript("CHECK_GLOBAL_KEY_DOWN_EVENT_TO_HIDE_CONTEXT_MENU_JS_PLUGIN_SCRIPT", "(function(){  document.addEventListener('keydown', function(e) {    window.flutter_inappwebview._hideContextMenu();  });})();", UserScriptInjectionTime.AT_DOCUMENT_START, null, false, null);
...
/* Location:
 * Qualified Name:     com.pichillilorenzo.flutter_inappwebview_android.plugin_scripts_js.PluginScriptsUtil
