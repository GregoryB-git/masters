...
public class JsConfirmResponse
{
  ...
  public JsConfirmResponse(String paramString1, String paramString2, String paramString3, boolean paramBoolean, Integer paramInteger)
  {
  ...
  public static JsConfirmResponse fromMap(Map<String, Object> paramMap)
  {
    if (paramMap == null) {
      return null;
    }
    return new JsConfirmResponse((String)paramMap.get("message"), (String)paramMap.get("confirmButtonTitle"), (String)paramMap.get("cancelButtonTitle"), ((Boolean)paramMap.get("handledByClient")).booleanValue(), (Integer)paramMap.get("action"));
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      paramObject = (JsConfirmResponse)paramObject;
...
/* Location:
 * Qualified Name:     com.pichillilorenzo.flutter_inappwebview_android.types.JsConfirmResponse
