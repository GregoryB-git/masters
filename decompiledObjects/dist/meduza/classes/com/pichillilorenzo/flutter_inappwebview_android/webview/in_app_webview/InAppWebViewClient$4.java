...
class InAppWebViewClient$4
  extends WebViewChannelDelegate.ReceivedClientCertRequestCallback
{
  public InAppWebViewClient$4(InAppWebViewClient paramInAppWebViewClient, InAppWebView paramInAppWebView, ClientCertRequest paramClientCertRequest, WebView paramWebView) {}
  
  public void defaultBehaviour(ClientCertResponse paramClientCertResponse)
  {
    InAppWebViewClient.access$501(this$0, val$view, val$request);
  }
  ...
  public boolean nonNullSuccess(ClientCertResponse paramClientCertResponse)
  {
    ...
    if ((localObject != null) && (val$webView.plugin != null))
    {
      ...
      do
      {
        ...
        val$request.ignore();
        break;
        localObject = paramClientCertResponse.getCertificatePath();
        String str = paramClientCertResponse.getCertificatePassword();
        paramClientCertResponse = paramClientCertResponse.getKeyStoreType();
        paramClientCertResponse = Util.loadPrivateKeyAndCertificate(val$webView.plugin, (String)localObject, str, paramClientCertResponse);
...
/* Location:
 * Qualified Name:     com.pichillilorenzo.flutter_inappwebview_android.webview.in_app_webview.InAppWebViewClient.4
