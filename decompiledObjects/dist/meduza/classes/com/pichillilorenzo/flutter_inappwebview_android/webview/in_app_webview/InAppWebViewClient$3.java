...
class InAppWebViewClient$3
  extends WebViewChannelDelegate.ReceivedServerTrustAuthRequestCallback
{
  public InAppWebViewClient$3(InAppWebViewClient paramInAppWebViewClient, SslErrorHandler paramSslErrorHandler, WebView paramWebView, SslError paramSslError) {}
  
  public void defaultBehaviour(ServerTrustAuthResponse paramServerTrustAuthResponse)
  {
    InAppWebViewClient.access$401(this$0, val$view, val$handler, val$sslError);
  }
...
/* Location:
 * Qualified Name:     com.pichillilorenzo.flutter_inappwebview_android.webview.in_app_webview.InAppWebViewClient.3
