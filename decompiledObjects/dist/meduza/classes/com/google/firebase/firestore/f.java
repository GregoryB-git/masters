  ...
  extends h
{
  ...
  public f(String paramString, a parama)
  {
    ...
    if (paramString != null)
    {
      ...
      b.Z("A FirebaseFirestoreException should never be thrown for OK", bool, new Object[0]);
      a = parama;
      return;
    }
  ...
  public f(String paramString, a parama, Exception paramException)
  {
...
/* Location:
 * Qualified Name:     com.google.firebase.firestore.f
