...
final class zzana
{
  ...
  private static final com.google.android.gms.internal.firebase-auth-api.zzana.zzc zzf;
  ...
  static
  {
    ...
    localObject = null;
    label74:
    zzf = (com.google.android.gms.internal.firebase-auth-api.zzana.zzc)localObject;
    bool1 = false;
    if (localObject == null) {
      bool2 = false;
    } else {
  ...
  {
    // Byte code:
    //   0: new 213	com/google/android/gms/internal/firebase_auth_api/zzamz
    //   3: astore_0
    //   4: aload_0
    //   5: invokespecial 214	com/google/android/gms/internal/firebase_auth_api/zzamz:<init>	()V
    //   8: aload_0
    //   9: invokestatic 220	java/security/AccessController:doPrivileged	(Ljava/security/PrivilegedExceptionAction;)Ljava/lang/Object;
...
/* Location:
 * Qualified Name:     com.google.android.gms.internal.firebase_auth_api.zzana
