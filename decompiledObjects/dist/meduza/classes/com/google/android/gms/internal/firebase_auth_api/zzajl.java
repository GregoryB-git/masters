  ...
  extends zzaji
{
  ...
  private zzajl(byte[] paramArrayOfByte, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    super(null);
  ...
  public final com.google.android.gms.internal.firebase-auth-api.zzaiw zzq()
  {
    ...
    if (i > 0)
    {
      ...
      if (i <= k - j)
      {
        i += j;
        zzg = i;
        localObject = Arrays.copyOfRange(zzd, j, i);
        break label115;
      }
    }
    if (i <= 0)
    {
      if (i == 0)
      {
        localObject = zzaki.zzb;
        label115:
        return zzaiw.zzb((byte[])localObject);
      }
      throw zzakm.zzf();
    }
    throw zzakm.zzj();
  ...
  public final String zzr()
  {
    ...
    if (i > 0)
    {
      ...
      if (i <= j - k)
      {
        String str = new String(zzd, k, i, zzaki.zza);
        zzg += i;
        return str;
      }
    }
...
/* Location:
 * Qualified Name:     com.google.android.gms.internal.firebase_auth_api.zzajl
