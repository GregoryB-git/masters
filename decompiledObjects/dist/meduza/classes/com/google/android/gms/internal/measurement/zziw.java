  ...
  implements zzly, RandomAccess
{
  ...
  static
  {
    ...
    zza = arrayOfBoolean;
    new zziw(arrayOfBoolean, 0, false);
  }
  ...
  private zziw(boolean[] paramArrayOfBoolean, int paramInt, boolean paramBoolean)
  {
    super(paramBoolean);
  ...
  public final boolean addAll(Collection<? extends Boolean> paramCollection)
  {
    ...
    if (!(paramCollection instanceof zziw)) {
      return super.addAll(paramCollection);
    }
    paramCollection = (zziw)paramCollection;
    int i = zzc;
    if (i == 0) {
      return false;
    }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if (!(paramObject instanceof zziw)) {
      return super.equals(paramObject);
    }
    paramObject = (zziw)paramObject;
    if (zzc != zzc) {
      return false;
    }
    paramObject = zzb;
