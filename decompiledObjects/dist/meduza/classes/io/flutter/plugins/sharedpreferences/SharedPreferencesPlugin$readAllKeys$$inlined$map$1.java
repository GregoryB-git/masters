...
public final class SharedPreferencesPlugin$readAllKeys$$inlined$map$1
  implements qc.e<Set<? extends d.a<?>>>
{
  public SharedPreferencesPlugin$readAllKeys$$inlined$map$1(qc.e parame) {}
    ...
    paramf = $this_unsafeTransform$inlined.collect(new qc.f()
    {
      public final Object emit(Object paramAnonymousObject, ub.e paramAnonymouse)
      {
        ...
        else
        {
          ...
          paramAnonymousObject = ((d)paramAnonymousObject).a().keySet();
          label = 1;
...
/* Location:
 * Qualified Name:     io.flutter.plugins.sharedpreferences.SharedPreferencesPlugin.readAllKeys..inlined.map.1
