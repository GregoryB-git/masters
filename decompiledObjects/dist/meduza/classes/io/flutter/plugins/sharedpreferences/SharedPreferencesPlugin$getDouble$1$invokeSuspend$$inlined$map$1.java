...
public final class SharedPreferencesPlugin$getDouble$1$invokeSuspend$$inlined$map$1
  implements qc.e<Double>
{
  public SharedPreferencesPlugin$getDouble$1$invokeSuspend$$inlined$map$1(qc.e parame, SharedPreferencesPlugin paramSharedPreferencesPlugin, d.a parama) {}
    ...
    paramf = $this_unsafeTransform$inlined.collect(new qc.f()
    {
      public final Object emit(Object paramAnonymousObject, ub.e paramAnonymouse)
      {
        ...
        else
        {
          ...
          paramAnonymousObject = (Double)SharedPreferencesPlugin.access$transformPref(this$0, ((d)paramAnonymousObject).b($preferencesKey$inlined));
          label = 1;
...
/* Location:
 * Qualified Name:     io.flutter.plugins.sharedpreferences.SharedPreferencesPlugin.getDouble.1.invokeSuspend..inlined.map.1
