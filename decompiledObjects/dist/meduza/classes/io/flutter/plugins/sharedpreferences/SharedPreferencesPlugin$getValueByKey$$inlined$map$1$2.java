...
public final class SharedPreferencesPlugin$getValueByKey$$inlined$map$1$2<T>
  implements qc.f
{
  public SharedPreferencesPlugin$getValueByKey$$inlined$map$1$2(qc.f paramf, d.a parama) {}
  ...
  public final Object emit(Object paramObject, ub.e parame)
  {
    ...
    else
    {
      ...
      paramObject = ((d)paramObject).b($key$inlined);
      label = 1;
...
/* Location:
 * Qualified Name:     io.flutter.plugins.sharedpreferences.SharedPreferencesPlugin.getValueByKey..inlined.map.1.2
