...
public final class SharedPreferencesPlugin$getString$1$invokeSuspend$$inlined$map$1
  implements qc.e<String>
{
  public SharedPreferencesPlugin$getString$1$invokeSuspend$$inlined$map$1(qc.e parame, d.a parama) {}
    ...
    paramf = $this_unsafeTransform$inlined.collect(new qc.f()
    {
      public final Object emit(Object paramAnonymousObject, ub.e paramAnonymouse)
      {
        ...
        else
        {
          ...
          paramAnonymousObject = ((d)paramAnonymousObject).b($preferencesKey$inlined);
          label = 1;
...
/* Location:
 * Qualified Name:     io.flutter.plugins.sharedpreferences.SharedPreferencesPlugin.getString.1.invokeSuspend..inlined.map.1
