...
final class SharedPreferencesPlugin$getDouble$1
  extends wb.i
  implements p<d0, ub.e<? super h>, Object>
{
  ...
  public SharedPreferencesPlugin$getDouble$1(String paramString, SharedPreferencesPlugin paramSharedPreferencesPlugin, s<Double> params, ub.e<? super 1> parame)
  {
    super(2, parame);
  }
          ...
          paramAnonymousf = $this_unsafeTransform$inlined.collect(new qc.f()
          {
            public final Object emit(Object paramAnonymous2Object, ub.e paramAnonymous2e)
            {
              ...
              else
              {
                ...
                paramAnonymous2Object = (d)paramAnonymous2Object;
                paramAnonymous2Object = (Double)SharedPreferencesPlugin.access$transformPref(this$0, ((d)paramAnonymous2Object).b($preferencesKey$inlined));
                label = 1;
...
/* Location:
 * Qualified Name:     io.flutter.plugins.sharedpreferences.SharedPreferencesPlugin.getDouble.1
