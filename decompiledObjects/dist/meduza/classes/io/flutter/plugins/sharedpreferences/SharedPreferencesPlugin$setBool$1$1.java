...
final class SharedPreferencesPlugin$setBool$1$1
  extends i
  implements p<r0.a, ub.e<? super h>, Object>
{
  public int label;
  
  public SharedPreferencesPlugin$setBool$1$1(d.a<Boolean> parama, boolean paramBoolean, ub.e<? super 1> parame)
  {
    super(2, parame);
  }
  ...
  {
    parame = new 1($boolKey, $value, parame);
    L$0 = paramObject;
    return parame;
  }
...
/* Location:
 * Qualified Name:     io.flutter.plugins.sharedpreferences.SharedPreferencesPlugin.setBool.1.1
