...
public abstract interface ITrustedWebActivityService
  extends IInterface
{
  public static final String l = "android$support$customtabs$trusted$ITrustedWebActivityService".replace('$', '.');
...
/* Location:
 * Qualified Name:     android.support.customtabs.trusted.ITrustedWebActivityService
