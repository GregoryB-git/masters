  ...
  implements Executor
{
  ...
  {
    m6.j.i(paramExecutor);
    a = paramExecutor;
  }
  
  public final void execute(Runnable paramRunnable)
  {
    m6.j.i(paramRunnable);
    synchronized (b)
    {
      int i = c;
      int j;
  ...
  {
    StringBuilder localStringBuilder = f.l("SequentialExecutor@");
    ...
    implements Runnable
  {
    ...
    public final void a()
    {
      ...
      //   5	244	3	j	int
      //   13	113	4	localArrayDeque	ArrayDeque
    ...
    public final String toString()
    {
      ...
      ((StringBuilder)localObject).append(g.m(c));
