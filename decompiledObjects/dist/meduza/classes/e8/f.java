  ...
  implements ScheduledExecutorService
{
  ...
  public f(ExecutorService paramExecutorService, ScheduledExecutorService paramScheduledExecutorService)
  {
  ...
  {
    return new g(new b(this, paramRunnable, paramLong, paramTimeUnit));
  }
  
  public final <V> ScheduledFuture<V> schedule(Callable<V> paramCallable, long paramLong, TimeUnit paramTimeUnit)
  {
    return new g(new i(this, paramCallable, paramLong, paramTimeUnit));
  }
  ...
  {
    return new g(new d(this, paramRunnable, paramLong1, paramLong2, paramTimeUnit));
  }
  ...
  {
    return new g(new c(this, paramRunnable, paramLong1, paramLong2, paramTimeUnit));
  }
