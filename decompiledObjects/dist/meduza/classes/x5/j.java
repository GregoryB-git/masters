  ...
  extends GLSurfaceView
{
  ...
  public j(Context paramContext)
  {
    ...
    Object localObject2 = paramContext.getSystemService("sensor");
    localObject2.getClass();
    SensorManager localSensorManager = (SensorManager)localObject2;
    b = localSensorManager;
    if (e0.a >= 18) {
      localObject1 = localSensorManager.getDefaultSensor(15);
    }
    localObject2 = localObject1;
    if (localObject1 == null) {
      localObject2 = localSensorManager.getDefaultSensor(11);
    }
    c = ((Sensor)localObject2);
    localObject1 = new i();
    f = ((i)localObject1);
    localObject1 = new a((i)localObject1);
    localObject2 = new k(paramContext, (a)localObject1);
    paramContext = (WindowManager)paramContext.getSystemService("window");
    paramContext.getClass();
    d = new d(paramContext.getDefaultDisplay(), new d.a[] { localObject2, localObject1 });
    q = true;
    setEGLContextClientVersion(2);
    setRenderer((GLSurfaceView.Renderer)localObject1);
    setOnTouchListener((View.OnTouchListener)localObject2);
  }
  ...
  public final void a()
  {
    ...
    Sensor localSensor = c;
    if ((localSensor != null) && (bool != s))
    {
      if (bool) {
        b.registerListener(d, localSensor, 0);
      } else {
