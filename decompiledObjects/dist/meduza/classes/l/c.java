  ...
  implements j
{
  ...
  public c(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    l locall = new l(this);
    c = locall;
    locall.c(paramAttributeSet, 2130968628);
    paramContext = getKeyListener();
    if ((paramContext instanceof NumberKeyListener ^ true))
    {
      boolean bool1 = super.isFocusable();
      boolean bool2 = super.isClickable();
      boolean bool3 = super.isLongClickable();
      paramInt = super.getInputType();
      paramAttributeSet = locall.b(paramContext);
      if (paramAttributeSet != paramContext)
      {
        super.setKeyListener(paramAttributeSet);
