  ...
  implements PooledByteBufferFactory
{
  ...
  @VisibleForTesting
  public NativePooledByteBuffer newByteBuf(InputStream paramInputStream, NativePooledByteBufferOutputStream paramNativePooledByteBufferOutputStream)
    throws IOException
  {
    mPooledByteStreams.copy(paramInputStream, paramNativePooledByteBufferOutputStream);
  ...
  public NativePooledByteBuffer newByteBuffer(InputStream paramInputStream)
    throws IOException
  {
    NativePooledByteBufferOutputStream localNativePooledByteBufferOutputStream = new NativePooledByteBufferOutputStream(mPool);
    try
    {
  ...
  public NativePooledByteBuffer newByteBuffer(InputStream paramInputStream, int paramInt)
    throws IOException
  {
    NativePooledByteBufferOutputStream localNativePooledByteBufferOutputStream = new NativePooledByteBufferOutputStream(mPool, paramInt);
    try
    {
      paramInputStream = newByteBuf(paramInputStream, localNativePooledByteBufferOutputStream);
      return paramInputStream;
  ...
  public NativePooledByteBuffer newByteBuffer(byte[] paramArrayOfByte)
  {
    ...
    //   0	49	0	this	NativePooledByteBufferFactory
    //   0	49	1	paramArrayOfByte	byte[]
    //   13	31	2	localNativePooledByteBufferOutputStream	NativePooledByteBufferOutputStream
    // Exception table:
    //   from	to	target	type
    //   14	27	33	finally
    //   38	43	33	finally
  ...
  {
    return new NativePooledByteBufferOutputStream(mPool, paramInt);
  }
}
