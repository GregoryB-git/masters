...
class MultiplexProducer$Multiplexer
{
  ...
  public MultiplexProducer$Multiplexer(K paramK)
  {
    Object localObject;
    mKey = localObject;
  }
  ...
  private void startInputProducerIfHasAttachedConsumers()
  {
    try
    {
      ...
      {
        MultiplexProducer.access$700(this$0, mKey, this);
        return;
      }
      ...
      MultiplexProducer.access$900(this$0).produceResults((Consumer)localObject3, (ProducerContext)localObject1);
      return;
    }
    finally {}
  }
  ...
  public void onNextResult(MultiplexProducer<K, T>.Multiplexer.ForwardingConsumer arg1, T paramT, int paramInt)
  {
    try
    {
      ...
      {
        mLastIntermediateResult = this$0.cloneOrNull(paramT);
...
/* Location:
 * Qualified Name:     com.facebook.imagepipeline.producers.MultiplexProducer.Multiplexer
