...
class PostprocessorProducer$PostprocessorConsumer
  extends DelegatingConsumer<CloseableReference<CloseableImage>, CloseableReference<CloseableImage>>
{
  ...
  public PostprocessorProducer$PostprocessorConsumer(final Consumer<CloseableReference<CloseableImage>> paramConsumer, ProducerListener paramProducerListener, String paramString, Postprocessor paramPostprocessor, ProducerContext paramProducerContext)
  {
    super(paramProducerListener);
  ...
  private CloseableReference<CloseableImage> postprocessInternal(CloseableImage paramCloseableImage)
  {
    ...
    localObject = mPostprocessor.process((Bitmap)localObject, PostprocessorProducer.access$900(this$0));
  ...
  {
    PostprocessorProducer.access$800(this$0).execute(new Runnable()
    {
      /* Error */
      public void run()
      {
...
/* Location:
 * Qualified Name:     com.facebook.imagepipeline.producers.PostprocessorProducer.PostprocessorConsumer
