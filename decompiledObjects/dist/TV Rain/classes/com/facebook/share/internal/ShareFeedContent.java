  ...
  extends ShareContent<ShareFeedContent, Builder>
{
  ...
  {
    super(paramBuilder);
    toId = Builder.access$000(paramBuilder);
    link = Builder.access$100(paramBuilder);
    linkName = Builder.access$200(paramBuilder);
    linkCaption = Builder.access$300(paramBuilder);
    linkDescription = Builder.access$400(paramBuilder);
    picture = Builder.access$500(paramBuilder);
    mediaSource = Builder.access$600(paramBuilder);
  }
