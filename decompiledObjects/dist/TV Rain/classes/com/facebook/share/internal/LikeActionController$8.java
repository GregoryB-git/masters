...
{
  public LikeActionController$8(LikeActionController paramLikeActionController, LikeActionController.PublishUnlikeRequestWrapper paramPublishUnlikeRequestWrapper, Bundle paramBundle) {}
  ...
  public void onBatchCompleted(GraphRequestBatch paramGraphRequestBatch)
  {
    ...
    else
    {
      ...
      LikeActionController.access$1200(this$0).logEventImplicitly("fb_like_control_did_unlike", null, val$analyticsParameters);
