  ...
  extends FacebookDialogBase<GameRequestContent, GameRequestDialog.Result>.ModeHandler
{
  ...
  {
    if ((CustomTabUtils.getChromePackage() != null) && (Validate.hasCustomTabRedirectActivity(GameRequestDialog.access$300(this$0), CustomTabUtils.getDefaultRedirectURI()))) {
      paramBoolean = true;
    } else {
      paramBoolean = false;
    }
...
/* Location:
 * Qualified Name:     com.facebook.share.widget.GameRequestDialog.ChromeCustomTabHandler
