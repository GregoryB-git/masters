...
{
  public ShareApi$2(ShareApi paramShareApi, Bundle paramBundle, ShareOpenGraphAction paramShareOpenGraphAction, GraphRequest.Callback paramCallback, FacebookCallback paramFacebookCallback) {}
  ...
  public void onComplete()
  {
    try
    {
      ...
      localGraphRequest.<init>(AccessToken.getCurrentAccessToken(), ShareApi.access$100(this$0, URLEncoder.encode(val$action.getActionType(), "UTF-8")), val$parameters, HttpMethod.POST, val$requestCallback);
