...
final class ExoSoSource$ExoUnpacker
  extends UnpackingSoSource.Unpacker
{
  private final ExoSoSource.FileDso[] mDsos;
  
  /* Error */
  public ExoSoSource$ExoUnpacker(ExoSoSource paramExoSoSource, UnpackingSoSource paramUnpackingSoSource)
    throws IOException
  {
    // Byte code:
    //   0: aload_0
    ...
    //   0	499	1	paramExoSoSource	ExoSoSource
    ...
    //   47	51	4	localFile1	java.io.File
    ...
    //   321	18	17	localFile2	java.io.File
    // Exception table:
    //   from	to	target	type
    //   168	174	414	finally
    //   179	187	414	finally
...
/* Location:
 * Qualified Name:     com.facebook.soloader.ExoSoSource.ExoUnpacker
