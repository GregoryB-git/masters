...
public class DraweeEventTracker
{
  ...
  {
    DraweeEventTracker localDraweeEventTracker;
    if (sEnabled) {
      localDraweeEventTracker = new DraweeEventTracker();
    } else {
      localDraweeEventTracker = sInstance;
    }
    return localDraweeEventTracker;
  }
