  ...
  implements ClearableSurface
{
  ...
  public ResizingTextureView(Context paramContext)
  {
    super(paramContext);
  }
  
  public ResizingTextureView(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
  }
  
  public ResizingTextureView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    super(paramContext, paramAttributeSet, paramInt);
  }
  
  @TargetApi(21)
  public ResizingTextureView(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
  ...
  public void clearSurface()
  {
    ...
    try
    {
      ...
      localObject = localEGL10.eglCreateWindowSurface(localEGLDisplay, localObject[0], getSurfaceTexture(), new int[] { 12344 });
    ...
    {
      Log.e("ResizingTextureView", "Error clearing surface", localException);
    }
  }
    ...
    implements ViewTreeObserver.OnGlobalLayoutListener
  {
    ...
    {
      ResizingTextureView localResizingTextureView = ResizingTextureView.this;
...
/* Location:
 * Qualified Name:     com.devbrackets.android.exomedia.core.video.ResizingTextureView
