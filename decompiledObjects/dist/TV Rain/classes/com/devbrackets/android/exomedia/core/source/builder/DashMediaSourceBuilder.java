  ...
  extends MediaSourceBuilder
{
  ...
  public MediaSource build(@NonNull Context paramContext, @NonNull Uri paramUri, @NonNull String paramString, @NonNull Handler paramHandler, @Nullable TransferListener paramTransferListener)
  {
    ...
    return new DashMediaSource.Factory(new DefaultDashChunkSource.Factory(buildDataSourceFactory(paramContext, paramString, paramTransferListener)), paramHandler).createMediaSource(paramUri);
  }
}

/* Location:
 * Qualified Name:     com.devbrackets.android.exomedia.core.source.builder.DashMediaSourceBuilder
