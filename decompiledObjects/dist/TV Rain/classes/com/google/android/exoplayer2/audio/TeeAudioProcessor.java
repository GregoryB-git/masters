  ...
  implements AudioProcessor
{
  ...
  public TeeAudioProcessor(AudioBufferSink paramAudioBufferSink)
  {
    ...
    paramAudioBufferSink = AudioProcessor.EMPTY_BUFFER;
    buffer = paramAudioBufferSink;
    outputBuffer = paramAudioBufferSink;
    channelCount = -1;
    sampleRateHz = -1;
  }
  ...
  {
    boolean bool;
    if ((inputEnded) && (buffer == AudioProcessor.EMPTY_BUFFER)) {
      bool = true;
    } else {
      bool = false;
    }
...
/* Location:
 * Qualified Name:     com.google.android.exoplayer2.audio.TeeAudioProcessor
