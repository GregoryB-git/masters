  ...
  extends EmojiCompat.Config
{
  ...
  public FontRequestEmojiCompatConfig(@NonNull Context paramContext, @NonNull FontRequest paramFontRequest)
  {
    super(new FontRequestMetadataLoader(paramContext, paramFontRequest, DEFAULT_FONTS_CONTRACT));
  }
  
  @RestrictTo({androidx.annotation.RestrictTo.Scope.LIBRARY})
  public FontRequestEmojiCompatConfig(@NonNull Context paramContext, @NonNull FontRequest paramFontRequest, @NonNull FontProviderHelper paramFontProviderHelper)
  {
  ...
  @Deprecated
  @NonNull
  public FontRequestEmojiCompatConfig setHandler(@Nullable Handler paramHandler)
  {
  ...
  @NonNull
  public FontRequestEmojiCompatConfig setLoadingExecutor(@NonNull Executor paramExecutor)
  {
  ...
  @NonNull
  public FontRequestEmojiCompatConfig setRetryPolicy(@Nullable RetryPolicy paramRetryPolicy)
  {
  ...
  public static class FontRequestMetadataLoader
    implements EmojiCompat.MetadataRepoLoader
  {
    ...
    public FontRequestMetadataLoader(@NonNull Context paramContext, @NonNull FontRequest paramFontRequest, @NonNull FontRequestEmojiCompatConfig.FontProviderHelper paramFontProviderHelper)
    {
