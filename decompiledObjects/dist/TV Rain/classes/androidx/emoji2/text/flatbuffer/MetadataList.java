  ...
  extends Table
{
  ...
  public static MetadataList getRootAsMetadataList(ByteBuffer paramByteBuffer, MetadataList paramMetadataList)
  {
    ...
    return paramMetadataList.__assign(paramByteBuffer.position() + i, paramByteBuffer);
  }
  ...
  public MetadataItem list(MetadataItem paramMetadataItem, int paramInt)
  {
    int i = __offset(6);
    if (i != 0) {
      paramMetadataItem = paramMetadataItem.__assign(__indirect(paramInt * 4 + __vector(i)), bb);
    } else {
  ...
  public MetadataItem.Vector listVector(MetadataItem.Vector paramVector)
  {
    int i = __offset(6);
    if (i != 0) {
      paramVector = paramVector.__assign(__vector(i), 4, bb);
    } else {
      paramVector = null;
    }
    return paramVector;
