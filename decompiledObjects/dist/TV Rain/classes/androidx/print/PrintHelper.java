...
public final class PrintHelper
{
  ...
  public static Bitmap convertBitmapForColorMode(Bitmap paramBitmap, int paramInt)
  {
    if (paramInt != 1) {
      return paramBitmap;
    }
  ...
  public static boolean isPortrait(Bitmap paramBitmap)
  {
    boolean bool;
    ...
    throws FileNotFoundException
  {
    ...
    //   1: ifnull +87 -> 88
    //   4: aload_0
    //   5: getfield 73	androidx/print/PrintHelper:mContext	Landroid/content/Context;
    //   8: astore_3
    //   9: aload_3
    //   10: ifnull +78 -> 88
    //   13: aconst_null
    //   14: astore 4
    //   16: aload_3
    //   17: invokevirtual 217	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   20: aload_1
    //   21: invokevirtual 223	android/content/ContentResolver:openInputStream	(Landroid/net/Uri;)Ljava/io/InputStream;
    //   24: astore_3
    //   25: aload_3
    //   26: aconst_null
    //   27: aload_2
    //   28: invokestatic 229	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   31: astore_1
    //   32: aload_3
    //   33: ifnull +20 -> 53
    //   36: aload_3
    //   37: invokevirtual 234	java/io/InputStream:close	()V
    //   40: goto +13 -> 53
    //   43: astore_2
    //   44: ldc 33
    //   46: ldc -20
    //   48: aload_2
    //   49: invokestatic 242	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   52: pop
    //   53: aload_1
    //   54: areturn
    //   55: astore_1
    ...
    //   66: ifnull +20 -> 86
    //   69: aload_2
    //   70: invokevirtual 234	java/io/InputStream:close	()V
    //   73: goto +13 -> 86
    //   76: astore_2
    //   77: ldc 33
    //   79: ldc -20
    //   81: aload_2
    //   82: invokestatic 242	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   85: pop
    //   86: aload_1
    //   87: athrow
    //   88: new 244	java/lang/IllegalArgumentException
    //   91: dup
    //   92: ldc -10
    //   94: invokespecial 249	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;)V
    //   97: athrow
  ...
  /* Error */
  public Bitmap loadConstrainedBitmap(Uri arg1)
    throws FileNotFoundException
  {
    // Byte code:
    //   0: aload_1
    ...
    //   5: getfield 73	androidx/print/PrintHelper:mContext	Landroid/content/Context;
    //   8: ifnull +196 -> 204
    //   11: new 258	android/graphics/BitmapFactory$Options
    //   14: dup
    //   15: invokespecial 259	android/graphics/BitmapFactory$Options:<init>	()V
    //   18: astore_2
    //   19: aload_2
    //   20: iconst_1
    //   21: putfield 262	android/graphics/BitmapFactory$Options:inJustDecodeBounds	Z
    //   24: aload_0
    //   25: aload_1
    //   26: aload_2
    //   27: invokespecial 264	androidx/print/PrintHelper:loadBitmap	(Landroid/net/Uri;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   30: pop
    //   31: aload_2
    //   32: getfield 267	android/graphics/BitmapFactory$Options:outWidth	I
    //   35: istore_3
    //   36: aload_2
    //   37: getfield 270	android/graphics/BitmapFactory$Options:outHeight	I
    //   40: istore 4
    //   42: iload_3
    //   43: ifle +159 -> 202
    //   46: iload 4
    ...
    //   54: iload_3
    //   55: iload 4
    //   57: invokestatic 273	java/lang/Math:max	(II)I
    //   60: istore 5
    //   62: iconst_1
    //   63: istore 6
    //   65: iload 5
    ...
    //   93: iload_3
    //   94: iload 4
    //   96: invokestatic 275	java/lang/Math:min	(II)I
    //   99: iload 6
    //   101: idiv
    //   102: ifgt +6 -> 108
    //   105: goto +97 -> 202
    //   108: aload_0
    //   109: getfield 65	androidx/print/PrintHelper:mLock	Ljava/lang/Object;
    //   112: astore_2
    //   113: aload_2
    //   114: monitorenter
    //   115: new 258	android/graphics/BitmapFactory$Options
    //   118: astore 7
    //   120: aload 7
    //   122: invokespecial 259	android/graphics/BitmapFactory$Options:<init>	()V
    //   125: aload_0
    //   126: aload 7
    //   128: putfield 63	androidx/print/PrintHelper:mDecodeOptions	Landroid/graphics/BitmapFactory$Options;
    //   131: aload 7
    //   133: iconst_1
    //   134: putfield 278	android/graphics/BitmapFactory$Options:inMutable	Z
    //   137: aload 7
    //   139: iload 6
    //   141: putfield 281	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   144: aload_2
    //   145: monitorexit
    //   146: aload_0
    //   147: aload_1
    //   148: aload 7
    //   150: invokespecial 264	androidx/print/PrintHelper:loadBitmap	(Landroid/net/Uri;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   153: astore_2
    //   154: aload_0
    //   155: getfield 65	androidx/print/PrintHelper:mLock	Ljava/lang/Object;
    //   158: astore_1
    //   159: aload_1
    //   160: monitorenter
    //   161: aload_0
    //   162: aconst_null
    //   163: putfield 63	androidx/print/PrintHelper:mDecodeOptions	Landroid/graphics/BitmapFactory$Options;
    //   166: aload_1
    //   167: monitorexit
    //   168: aload_2
    //   169: areturn
    ...
    //   175: astore_2
    //   176: aload_0
    //   177: getfield 65	androidx/print/PrintHelper:mLock	Ljava/lang/Object;
    //   180: astore_1
    //   181: aload_1
    //   182: monitorenter
    //   183: aload_0
    //   184: aconst_null
    //   185: putfield 63	androidx/print/PrintHelper:mDecodeOptions	Landroid/graphics/BitmapFactory$Options;
    //   188: aload_1
    //   189: monitorexit
    //   190: aload_2
    //   191: athrow
    ...
    //   202: aconst_null
    //   203: areturn
    //   204: new 244	java/lang/IllegalArgumentException
    //   207: dup
    //   208: ldc_w 283
    //   211: invokespecial 249	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;)V
    //   214: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public void printBitmap(@NonNull String paramString, @NonNull Uri paramUri, @Nullable OnPrintFinishCallback paramOnPrintFinishCallback)
    throws FileNotFoundException
  {
    PrintUriAdapter localPrintUriAdapter = new PrintUriAdapter(paramString, paramUri, paramOnPrintFinishCallback, mScaleMode);
    paramOnPrintFinishCallback = (PrintManager)mContext.getSystemService("print");
    paramUri = new PrintAttributes.Builder();
    paramUri.setColorMode(mColorMode);
    int i = mOrientation;
    if ((i != 1) && (i != 0))
    {
      if (i == 2) {
  ...
  @RequiresApi(19)
  public void writeBitmap(final PrintAttributes paramPrintAttributes, final int paramInt, final Bitmap paramBitmap, final ParcelFileDescriptor paramParcelFileDescriptor, final CancellationSignal paramCancellationSignal, final PrintDocumentAdapter.WriteResultCallback paramWriteResultCallback)
  {
    ...
    {
      /* Error */
      public Throwable doInBackground(Void... paramAnonymousVarArgs)
      {
        // Byte code:
        //   0: aload_0
      ...
      public void onPostExecute(Throwable paramAnonymousThrowable)
      {
  ...
  @RequiresApi(19)
  public class PrintBitmapAdapter
    extends PrintDocumentAdapter
  {
    ...
    public PrintBitmapAdapter(String paramString, int paramInt, Bitmap paramBitmap, PrintHelper.OnPrintFinishCallback paramOnPrintFinishCallback)
    {
    ...
    extends PrintDocumentAdapter
  {
    ...
    public PrintUriAdapter(String paramString, Uri paramUri, PrintHelper.OnPrintFinishCallback paramOnPrintFinishCallback, int paramInt)
    {
      mJobName = paramString;
      mImageFile = paramUri;
      mCallback = paramOnPrintFinishCallback;
    ...
    public void cancelLoad()
    {
      synchronized (mLock)
      {
        PrintHelper localPrintHelper = PrintHelper.this;
