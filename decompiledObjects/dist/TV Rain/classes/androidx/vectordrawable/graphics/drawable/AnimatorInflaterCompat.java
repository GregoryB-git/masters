...
public class AnimatorInflaterCompat
{
    ...
    throws XmlPullParserException, IOException
  {
    ...
    paramContext = z2.t("Unknown animator name: ");
  ...
  private static void dumpKeyframes(Object[] paramArrayOfObject, String paramString)
  {
    if ((paramArrayOfObject != null) && (paramArrayOfObject.length != 0))
    {
      ...
      for (int j = 0; j < i; j++)
      {
        ...
        StringBuilder localStringBuilder = a.r("Keyframe ", j, ": fraction ");
      ...
      else if (arrayOfPathDataNode1 != null)
      {
        ...
        if (arrayOfPathDataNode2 != null)
        {
          if (PathParser.canMorph(arrayOfPathDataNode1, arrayOfPathDataNode2)) {
            ...
            throw new InflateException(a.m(" Can't morph from ", (String)localObject2, " to ", str));
          }
        }
        else {
    ...
    throws Resources.NotFoundException
  {
    ...
    //   31: aload 8
    //   33: fload 4
    //   35: invokestatic 356	androidx/vectordrawable/graphics/drawable/AnimatorInflaterCompat:createAnimatorFromXml	(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;F)Landroid/animation/Animator;
    //   38: astore_0
    //   39: aload 8
    //   41: ifnull +10 -> 51
    //   44: aload 8
    ...
    //   58: aload 5
    //   60: astore 7
    //   62: new 338	android/content/res/Resources$NotFoundException
    //   65: astore_0
    //   66: aload 5
    //   68: astore 7
    //   70: new 139	java/lang/StringBuilder
    //   73: astore_2
    //   74: aload 5
    //   76: astore 7
    //   78: aload_2
    //   79: invokespecial 362	java/lang/StringBuilder:<init>	()V
    //   82: aload 5
    //   84: astore 7
    //   86: aload_2
    //   87: ldc_w 364
    ...
    //   116: invokespecial 368	android/content/res/Resources$NotFoundException:<init>	(Ljava/lang/String;)V
    //   119: aload 5
    //   121: astore 7
    //   123: aload_0
    //   124: aload_1
    //   125: invokevirtual 374	java/lang/Throwable:initCause	(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    //   128: pop
    //   129: aload 5
    //   131: astore 7
    //   133: aload_0
    ...
    //   136: aload 6
    //   138: astore 7
    //   140: new 338	android/content/res/Resources$NotFoundException
    //   143: astore_1
    //   144: aload 6
    //   146: astore 7
    //   148: new 139	java/lang/StringBuilder
    //   151: astore_0
    //   152: aload 6
    //   154: astore 7
    //   156: aload_0
    //   157: invokespecial 362	java/lang/StringBuilder:<init>	()V
    //   160: aload 6
    //   162: astore 7
    //   164: aload_0
    //   165: ldc_w 364
    ...
    //   176: aload_0
    //   177: iload_3
    //   178: invokestatic 367	java/lang/Integer:toHexString	(I)Ljava/lang/String;
    //   181: invokevirtual 142	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   184: pop
    //   185: aload 6
    //   187: astore 7
    //   189: aload_1
    ...
    //   194: invokespecial 368	android/content/res/Resources$NotFoundException:<init>	(Ljava/lang/String;)V
    //   197: aload 6
    //   199: astore 7
    //   201: aload_1
    //   202: aload_2
    //   203: invokevirtual 374	java/lang/Throwable:initCause	(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    //   206: pop
    //   207: aload 6
    //   209: astore 7
    //   211: aload_1
  ...
  private static void setupObjectAnimator(ValueAnimator paramValueAnimator, TypedArray paramTypedArray, int paramInt, float paramFloat, XmlPullParser paramXmlPullParser)
  {
    ...
    if (paramValueAnimator != null)
    {
      ...
      setupPathMotion(PathParser.createPathFromPathData(paramValueAnimator), localObjectAnimator, paramFloat * 0.5F, str, paramXmlPullParser);
    }
    else
    {
  ...
  private static void setupPathMotion(Path paramPath, ObjectAnimator paramObjectAnimator, float paramFloat, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      localPathMeasure2.getPosTan(paramFloat - ((Float)localArrayList.get(k)).floatValue(), paramPath, null);
      arrayOfFloat1[j] = paramPath[0];
      arrayOfFloat2[j] = paramPath[1];
      paramFloat += f2;
      int m = k + 1;
      int n = k;
    ...
    implements TypeEvaluator<PathParser.PathDataNode[]>
  {
    ...
    public PathDataEvaluator(PathParser.PathDataNode[] paramArrayOfPathDataNode)
    {
