...
public abstract class AppCompatDelegate
{
  ...
  public static void addActiveDelegate(@NonNull AppCompatDelegate paramAppCompatDelegate)
  {
  ...
  public static void removeActivityDelegate(@NonNull AppCompatDelegate paramAppCompatDelegate)
  {
    synchronized (sActivityDelegatesLock)
    {
      removeDelegateFromActives(paramAppCompatDelegate);
