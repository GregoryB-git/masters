...
public class AppCompatViewInflater
{
  ...
  private void backportAccessibilityAttributes(@NonNull Context paramContext, @NonNull View paramView, @NonNull AttributeSet paramAttributeSet)
  {
  ...
  private void checkOnClickListener(View paramView, AttributeSet paramAttributeSet)
  {
    ...
    if (((localObject instanceof ContextWrapper)) && (ViewCompat.hasOnClickListeners(paramView)))
    {
  ...
  private View createViewFromTag(Context paramContext, String paramString, AttributeSet paramAttributeSet)
  {
    ...
    //   3: aload_2
    //   4: ldc -62
    //   6: invokevirtual 198	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   9: ifeq +14 -> 23
    //   12: aload_3
    //   13: aconst_null
    //   14: ldc -56
    //   16: invokeinterface 204 3 0
    //   21: astore 4
    //   23: aload_0
    ...
    //   37: aload 4
    //   39: bipush 46
    //   41: invokevirtual 208	java/lang/String:indexOf	(I)I
    //   44: if_icmpne +69 -> 113
    //   47: iconst_0
    //   48: istore 5
    ...
    //   66: iload 5
    //   68: aaload
    //   69: invokespecial 210	androidx/appcompat/app/AppCompatViewInflater:createViewByPrefix	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    //   72: astore_2
    //   73: aload_2
    //   74: ifnull +18 -> 92
    //   77: aload_0
    ...
    //   115: aload 4
    //   117: aconst_null
    //   118: invokespecial 210	androidx/appcompat/app/AppCompatViewInflater:createViewByPrefix	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    //   121: astore_1
    //   122: aload_0
  ...
  public static class DeclaredOnClickListener
