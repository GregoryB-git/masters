  ...
  extends Resources
{
  ...
  public Drawable getDrawable(int paramInt, Resources.Theme paramTheme)
    throws Resources.NotFoundException
  {
    return ResourcesCompat.getDrawable(mResources, paramInt, paramTheme);
  }
  ...
  public Drawable getDrawableForDensity(int paramInt1, int paramInt2)
    throws Resources.NotFoundException
  {
    return ResourcesCompat.getDrawableForDensity(mResources, paramInt1, paramInt2, null);
  }
  
  @RequiresApi(21)
  public Drawable getDrawableForDensity(int paramInt1, int paramInt2, Resources.Theme paramTheme)
  {
    return ResourcesCompat.getDrawableForDensity(mResources, paramInt1, paramInt2, paramTheme);
  }
  ...
  public void getValueForDensity(int paramInt1, int paramInt2, TypedValue paramTypedValue, boolean paramBoolean)
    throws Resources.NotFoundException
  {
    Compatibility.Api15Impl.getValueForDensity(mResources, paramInt1, paramInt2, paramTypedValue, paramBoolean);
  }
