...
public class PathParser
{
  ...
  public static boolean canMorph(@Nullable PathDataNode[] paramArrayOfPathDataNode1, @Nullable PathDataNode[] paramArrayOfPathDataNode2)
  {
    if ((paramArrayOfPathDataNode1 != null) && (paramArrayOfPathDataNode2 != null))
    {
      ...
      {
        PathDataNode localPathDataNode1 = paramArrayOfPathDataNode1[i];
        int j = mType;
        PathDataNode localPathDataNode2 = paramArrayOfPathDataNode2[i];
        if ((j == mType) && (mParams.length == mParams.length)) {
          i++;
        } else {
          return false;
        }
  ...
  public static Path createPathFromPathData(String paramString)
  {
    ...
    if (arrayOfPathDataNode != null) {
      ...
      {
        throw new RuntimeException(z2.o("Error in parsing ", paramString), localRuntimeException);
      }
    }
    return null;
  }
  ...
  private static float[] getFloats(String paramString)
  {
    if ((paramString.charAt(0) != 'z') && (paramString.charAt(0) != 'Z')) {
      try
      {
        ...
        Object localObject = new androidx/core/graphics/PathParser$ExtractFloatResult;
      ...
      {
        throw new RuntimeException(z2.p("error in parsing \"", paramString, "\""), localNumberFormatException);
      }
    }
    return new float[0];
  }
  ...
  public static class PathDataNode
  {
    ...
    public PathDataNode(char paramChar, float[] paramArrayOfFloat)
    {
      mType = ((char)paramChar);
      mParams = paramArrayOfFloat;
    }
    
    public PathDataNode(PathDataNode paramPathDataNode)
    {
      mType = ((char)mType);
