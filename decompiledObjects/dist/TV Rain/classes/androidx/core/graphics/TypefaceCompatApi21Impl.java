  ...
  extends TypefaceCompatBaseImpl
{
  ...
  /* Error */
  public Typeface createFromFontFamilyFilesResourceEntry(Context paramContext, androidx.core.content.res.FontResourcesParserCompat.FontFamilyFilesResourceEntry paramFontFamilyFilesResourceEntry, android.content.res.Resources paramResources, int paramInt)
  {
    // Byte code:
    //   0: invokestatic 204	androidx/core/graphics/TypefaceCompatApi21Impl:newFamily	()Ljava/lang/Object;
    //   3: astore 5
    //   5: aload_2
    //   6: invokevirtual 210	androidx/core/content/res/FontResourcesParserCompat$FontFamilyFilesResourceEntry:getEntries	()[Landroidx/core/content/res/FontResourcesParserCompat$FontFileResourceEntry;
    //   9: astore 6
    //   11: aload 6
    //   13: arraylength
    //   14: istore 7
    ...
    //   31: astore 8
    //   33: aload_1
    //   34: invokestatic 216	androidx/core/graphics/TypefaceCompatUtil:getTempFile	(Landroid/content/Context;)Ljava/io/File;
    //   37: astore_2
    //   38: aload_2
    //   39: ifnonnull +5 -> 44
    //   42: aconst_null
    ...
    //   45: aload_3
    //   46: aload 8
    //   48: invokevirtual 221	androidx/core/content/res/FontResourcesParserCompat$FontFileResourceEntry:getResourceId	()I
    //   51: invokestatic 225	androidx/core/graphics/TypefaceCompatUtil:copyToFile	(Ljava/io/File;Landroid/content/res/Resources;I)Z
    //   54: istore 9
    //   56: iload 9
    //   58: ifne +10 -> 68
    //   61: aload_2
    //   62: invokevirtual 228	java/io/File:delete	()Z
    //   65: pop
    //   66: aconst_null
    //   67: areturn
    //   68: aload 5
    //   70: aload_2
    //   71: invokevirtual 231	java/io/File:getPath	()Ljava/lang/String;
    //   74: aload 8
    //   76: invokevirtual 234	androidx/core/content/res/FontResourcesParserCompat$FontFileResourceEntry:getWeight	()I
    //   79: aload 8
    //   81: invokevirtual 237	androidx/core/content/res/FontResourcesParserCompat$FontFileResourceEntry:isItalic	()Z
    //   84: invokestatic 239	androidx/core/graphics/TypefaceCompatApi21Impl:addFontWeightStyle	(Ljava/lang/Object;Ljava/lang/String;IZ)Z
    //   87: istore 9
    //   89: iload 9
    //   91: ifne +10 -> 101
    //   94: aload_2
    //   95: invokevirtual 228	java/io/File:delete	()Z
    //   98: pop
    //   99: aconst_null
    //   100: areturn
    //   101: aload_2
    //   102: invokevirtual 228	java/io/File:delete	()Z
    //   105: pop
    //   106: iinc 4 1
    //   109: goto -90 -> 19
    //   112: astore_1
    //   113: aload_2
    //   114: invokevirtual 228	java/io/File:delete	()Z
    //   117: pop
    //   118: aload_1
    //   119: athrow
    //   120: astore_1
    //   121: aload_2
    //   122: invokevirtual 228	java/io/File:delete	()Z
    //   125: pop
    //   126: aconst_null
    //   127: areturn
    //   128: aload 5
    //   130: invokestatic 241	androidx/core/graphics/TypefaceCompatApi21Impl:createFromFamiliesWithDefault	(Ljava/lang/Object;)Landroid/graphics/Typeface;
    //   133: areturn
  ...
  public Typeface createFromFontInfo(Context paramContext, android.os.CancellationSignal paramCancellationSignal, @NonNull androidx.core.provider.FontsContractCompat.FontInfo[] paramArrayOfFontInfo, int paramInt)
  {
    ...
    //   9: aload_3
    //   10: iload 4
    //   12: invokevirtual 249	androidx/core/graphics/TypefaceCompatBaseImpl:findBestInfo	([Landroidx/core/provider/FontsContractCompat$FontInfo;I)Landroidx/core/provider/FontsContractCompat$FontInfo;
    //   15: astore_3
    //   16: aload_1
    ...
    //   22: aload 5
    //   24: aload_3
    //   25: invokevirtual 261	androidx/core/provider/FontsContractCompat$FontInfo:getUri	()Landroid/net/Uri;
    //   28: ldc_w 263
    //   31: aload_2
    //   32: invokevirtual 269	android/content/ContentResolver:openFileDescriptor	(Landroid/net/Uri;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/os/ParcelFileDescriptor;
    //   35: astore_2
    //   36: aload_2
    //   37: ifnonnull +13 -> 50
    //   40: aload_2
    //   41: ifnull +7 -> 48
    //   44: aload_2
    //   45: invokevirtual 272	android/os/ParcelFileDescriptor:close	()V
    //   48: aconst_null
    //   49: areturn
    //   50: aload_0
    //   51: aload_2
    //   52: invokespecial 274	androidx/core/graphics/TypefaceCompatApi21Impl:getFile	(Landroid/os/ParcelFileDescriptor;)Ljava/io/File;
    //   55: astore_3
    //   56: aload_3
    //   57: ifnull +24 -> 81
    //   60: aload_3
    //   61: invokevirtual 277	java/io/File:canRead	()Z
    //   64: ifne +6 -> 70
    //   67: goto +14 -> 81
    //   70: aload_3
    //   71: invokestatic 281	android/graphics/Typeface:createFromFile	(Ljava/io/File;)Landroid/graphics/Typeface;
    //   74: astore_1
    //   75: aload_2
    //   76: invokevirtual 272	android/os/ParcelFileDescriptor:close	()V
    //   79: aload_1
    //   80: areturn
    //   81: new 283	java/io/FileInputStream
    //   84: astore_3
    //   85: aload_3
    //   86: aload_2
    //   87: invokevirtual 287	android/os/ParcelFileDescriptor:getFileDescriptor	()Ljava/io/FileDescriptor;
    //   90: invokespecial 290	java/io/FileInputStream:<init>	(Ljava/io/FileDescriptor;)V
    //   93: aload_0
    //   94: aload_1
    //   95: aload_3
    //   96: invokespecial 294	androidx/core/graphics/TypefaceCompatBaseImpl:createFromInputStream	(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
    //   99: astore_1
    //   100: aload_3
    //   101: invokevirtual 295	java/io/FileInputStream:close	()V
    //   104: aload_2
    //   105: invokevirtual 272	android/os/ParcelFileDescriptor:close	()V
    //   108: aload_1
    //   109: areturn
    //   110: astore_1
    //   111: aload_3
    //   112: invokevirtual 295	java/io/FileInputStream:close	()V
    //   115: goto +9 -> 124
    //   118: astore_3
    //   119: aload_1
    //   120: aload_3
    //   121: invokevirtual 300	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   124: aload_1
    //   125: athrow
    //   126: astore_1
    //   127: aload_2
    //   128: invokevirtual 272	android/os/ParcelFileDescriptor:close	()V
    //   131: goto +9 -> 140
    //   134: astore_2
    //   135: aload_1
    //   136: aload_2
    //   137: invokevirtual 300	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   140: aload_1
    //   141: athrow
    //   142: astore_1
    //   143: aconst_null
