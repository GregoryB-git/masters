...
{
  public OverlayViewGroup mOverlayViewGroup = new OverlayViewGroup(paramContext, paramViewGroup, paramView, this);
  
  public ViewOverlayApi14(Context paramContext, ViewGroup paramViewGroup, View paramView) {}
  
  public static ViewOverlayApi14 createFrom(View paramView)
  {
  ...
  public static class OverlayViewGroup
    extends ViewGroup
  {
    ...
    public OverlayViewGroup(Context paramContext, ViewGroup paramViewGroup, View paramView, ViewOverlayApi14 paramViewOverlayApi14)
    {
      super();
