  ...
  extends Transition
{
  ...
  public Animator createAnimator(@NonNull ViewGroup paramViewGroup, TransitionValues paramTransitionValues1, TransitionValues paramTransitionValues2)
  {
    ...
    if (paramTransitionValues1 != null) {
      ...
      {
        Rect localRect1 = (Rect)values.get("android:changeImageTransform:bounds");
        Rect localRect2 = (Rect)values.get("android:changeImageTransform:bounds");
        paramViewGroup = localMatrix;
        if (localRect1 != null) {
          if (localRect2 == null)
          {
          ...
          else
          {
            ...
            localMatrix = (Matrix)values.get("android:changeImageTransform:matrix");
