...
class MediaRouteProviderService$MediaRouteProviderServiceImplApi30$ClientRecord
  extends MediaRouteProviderService.MediaRouteProviderServiceImplBase.ClientRecord
{
  ...
  public MediaRouteProviderService$MediaRouteProviderServiceImplApi30$ClientRecord(MediaRouteProviderService.MediaRouteProviderServiceImplApi30 paramMediaRouteProviderServiceImplApi30, Messenger paramMessenger, int paramInt, String paramString)
  {
    super(paramMediaRouteProviderServiceImplApi30, paramMessenger, paramInt, paramString);
    if (paramInt < 4) {
  ...
  public Bundle createDynamicGroupRouteController(String paramString, int paramInt)
  {
    ...
    if ((localBundle != null) && (mPackageName != null)) {
      this$0.mMR2ProviderServiceAdapter.notifyRouteControllerAdded(this, (MediaRouteProvider.RouteController)mControllers.get(paramInt), paramInt, mPackageName, paramString);
    }
    return localBundle;
  }
  ...
  public boolean createRouteController(String paramString1, String paramString2, int paramInt)
  {
    ...
    if ((paramString2 == null) && (bool) && (mPackageName != null)) {
      this$0.mMR2ProviderServiceAdapter.notifyRouteControllerAdded(this, (MediaRouteProvider.RouteController)mControllers.get(paramInt), paramInt, mPackageName, paramString1);
    }
    if (bool) {
  ...
  public void dispose()
  {
    ...
    for (int j = 0; j < i; j++)
    {
      ...
      this$0.mMR2ProviderServiceAdapter.notifyRouteControllerRemoved(k);
    }
  ...
  {
    this$0.mMR2ProviderServiceAdapter.notifyRouteControllerRemoved(paramInt);
  ...
  {
    MediaRouteProviderDescriptor localMediaRouteProviderDescriptor = this$0.getService().getMediaRouteProvider().getDescriptor();
  ...
  public void sendDynamicRouteDescriptors(MediaRouteProvider.DynamicGroupRouteController paramDynamicGroupRouteController, MediaRouteDescriptor paramMediaRouteDescriptor, Collection<MediaRouteProvider.DynamicGroupRouteController.DynamicRouteDescriptor> paramCollection)
  {
    ...
    MediaRoute2ProviderServiceAdapter localMediaRoute2ProviderServiceAdapter = this$0.mMR2ProviderServiceAdapter;
...
/* Location:
 * Qualified Name:     androidx.mediarouter.media.MediaRouteProviderService.MediaRouteProviderServiceImplApi30.ClientRecord
