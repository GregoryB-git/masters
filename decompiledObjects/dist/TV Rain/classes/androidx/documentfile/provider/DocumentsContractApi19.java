...
class DocumentsContractApi19
{
  ...
  public static boolean exists(Context paramContext, Uri paramUri)
  {
    ...
    //   24: aconst_null
    //   25: aconst_null
    //   26: invokevirtual 78	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   29: astore_1
    //   30: aload_1
    //   31: astore_0
    //   32: aload_1
    ...
    //   49: istore_3
    //   50: aload_1
    //   51: invokestatic 86	androidx/documentfile/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   54: iload_3
    //   55: ireturn
    //   56: astore_1
    //   57: goto +57 -> 114
    ...
    //   88: aload_2
    //   89: aload_1
    //   90: invokevirtual 98	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   93: pop
    //   94: aload 4
    //   96: astore_0
    //   97: ldc 14
    ...
    //   103: invokestatic 108	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;)I
    //   106: pop
    //   107: aload 4
    ...
    //   113: ireturn
    //   114: aload_0
    //   115: invokestatic 86	androidx/documentfile/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   118: aload_1
    //   119: athrow
  ...
  private static long queryForLong(Context paramContext, Uri paramUri, String paramString, long paramLong)
  {
    ...
    //   99: astore_0
    //   100: aload_2
    //   101: invokespecial 89	java/lang/StringBuilder:<init>	()V
    //   104: aload 6
    //   106: astore_0
    //   107: aload_2
    //   108: ldc 91
    ...
    //   117: aload_2
    //   118: aload_1
    //   119: invokevirtual 98	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   122: pop
    //   123: aload 6
    //   125: astore_0
    //   126: ldc 14
    ...
    //   132: invokestatic 108	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;)I
    //   135: pop
    //   136: aload 6
    //   138: invokestatic 86	androidx/documentfile/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   141: lload_3
    //   142: lreturn
    //   143: aload_0
    //   144: invokestatic 86	androidx/documentfile/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   147: aload_1
    //   148: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  private static String queryForString(Context paramContext, Uri paramUri, String paramString1, @Nullable String paramString2)
  {
    ...
    //   97: astore_0
    //   98: aload_1
    //   99: invokespecial 89	java/lang/StringBuilder:<init>	()V
    //   102: aload 5
    //   104: astore_0
    //   105: aload_1
    //   106: ldc 91
    ...
    //   115: aload_1
    //   116: aload_2
    //   117: invokevirtual 98	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   120: pop
    //   121: aload 5
    //   123: astore_0
    //   124: ldc 14
    ...
    //   130: invokestatic 108	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;)I
    //   133: pop
    //   134: aload 5
    //   136: invokestatic 86	androidx/documentfile/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   139: aload_3
    //   140: areturn
    //   141: aload_0
    //   142: invokestatic 86	androidx/documentfile/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   145: aload_1
    //   146: athrow
    // Local variable table:
    //   start	length	slot	name	signature
