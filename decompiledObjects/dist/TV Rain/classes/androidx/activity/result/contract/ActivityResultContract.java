...
{
  @NotNull
  public abstract Intent createIntent(@NotNull Context paramContext, I paramI);
  
  @Nullable
  public SynchronousResult<O> getSynchronousResult(@NotNull Context paramContext, I paramI)
  {
