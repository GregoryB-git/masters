...
public final class SavedStateHandleSupport
{
  @JvmField
  @NotNull
  public static final CreationExtras.Key<Bundle> DEFAULT_ARGS_KEY = new CreationExtras.Key() {};
  @NotNull
  private static final String SAVED_STATE_KEY = "androidx.lifecycle.internal.SavedStateHandlesProvider";
  @JvmField
  @NotNull
  public static final CreationExtras.Key<SavedStateRegistryOwner> SAVED_STATE_REGISTRY_OWNER_KEY = new CreationExtras.Key() {};
  @NotNull
  private static final String VIEWMODEL_KEY = "androidx.lifecycle.internal.SavedStateHandlesVM";
  @JvmField
  @NotNull
  public static final CreationExtras.Key<ViewModelStoreOwner> VIEW_MODEL_STORE_OWNER_KEY = new CreationExtras.Key() {};
  
  @MainThread
  @NotNull
  public static final SavedStateHandle createSavedStateHandle(@NotNull CreationExtras paramCreationExtras)
  {
  ...
  @MainThread
  public static final <T extends SavedStateRegistryOwner,  extends ViewModelStoreOwner> void enableSavedStateHandles(@NotNull T paramT)
  {
    ...
    if (i != 0)
    {
      if (paramT.getSavedStateRegistry().getSavedStateProvider("androidx.lifecycle.internal.SavedStateHandlesProvider") == null)
      {
        ...
        paramT.getLifecycle().addObserver(new SavedStateHandleAttacher((SavedStateHandlesProvider)localObject));
      }
      return;
    }
  ...
  @NotNull
  public static final SavedStateHandlesProvider getSavedStateHandlesProvider(@NotNull SavedStateRegistryOwner paramSavedStateRegistryOwner)
  {
  ...
  @NotNull
  public static final SavedStateHandlesVM getSavedStateHandlesVM(@NotNull ViewModelStoreOwner paramViewModelStoreOwner)
  {
    ...
    localInitializerViewModelFactoryBuilder.addInitializer(Reflection.getOrCreateKotlinClass(SavedStateHandlesVM.class), local1);
