  ...
  implements Comparable<MotionPaths>
{
  ...
  public float mRelativeAngle = NaN.0F;
  ...
  public void applyParameters(MotionWidget paramMotionWidget)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localObject = paramMotionWidget.getCustomAttribute(str);
      if ((localObject != null) && (((CustomVariable)localObject).isContinuous())) {
        customAttributes.put(str, localObject);
      }
    }
  }
  ...
  public void getCenter(double paramDouble, int[] paramArrayOfInt, double[] paramArrayOfDouble, float[] paramArrayOfFloat, int paramInt)
  {
    ...
    if (paramArrayOfDouble != null)
    {
      ...
      paramDouble = f1;
      double d2 = f2;
      f6 = (float)(Math.sin(d2) * paramDouble + d1 - f3 / 2.0F);
      f5 = (float)(f5 - Math.cos(d2) * paramDouble - f4 / 2.0F);
    }
  ...
  public void getCenter(double paramDouble, int[] paramArrayOfInt, double[] paramArrayOfDouble1, float[] paramArrayOfFloat1, double[] paramArrayOfDouble2, float[] paramArrayOfFloat2)
  {
    ...
    paramArrayOfDouble1 = mRelativeToController;
    f6 = f1;
    f8 = f2;
    if (paramArrayOfDouble1 != null)
    {
      ...
      paramArrayOfDouble1.getCenter(paramDouble, paramArrayOfInt, paramArrayOfDouble2);
      f6 = paramArrayOfInt[0];
      ...
      f8 = (float)(f8 - Math.cos(paramDouble) * d2 - f4 / 2.0F);
      double d3 = f9;
      d1 = f5;
      ...
      d3 = f10;
      d5 = Math.cos(paramDouble);
      f10 = (float)(Math.sin(paramDouble) * d2 + (d3 - d5 * d1));
    }
    paramArrayOfFloat1[0] = (f3 / 2.0F + f6 + 0.0F);
    paramArrayOfFloat1[1] = (f4 / 2.0F + f8 + 0.0F);
    paramArrayOfFloat2[0] = f9;
    paramArrayOfFloat2[1] = f10;
  }
  ...
  public void getCenterVelocity(double paramDouble, int[] paramArrayOfInt, double[] paramArrayOfDouble, float[] paramArrayOfFloat, int paramInt)
  {
    ...
    if (paramArrayOfInt != null)
    {
      ...
      f5 = paramArrayOfDouble[1];
      double d1 = f6;
      paramDouble = f1;
      double d2 = f2;
      f2 = (float)(Math.sin(d2) * paramDouble + d1 - f3 / 2.0F);
      f5 = (float)(f5 - Math.cos(d2) * paramDouble - f4 / 2.0F);
      f6 = f2;
    }
    paramArrayOfFloat[paramInt] = (f3 / 2.0F + f6 + 0.0F);
  ...
  {
    CustomVariable localCustomVariable = (CustomVariable)customAttributes.get(paramString);
    int i = 0;
  ...
  {
    paramString = (CustomVariable)customAttributes.get(paramString);
    if (paramString == null) {
      return 0;
    }
  ...
  {
    return customAttributes.containsKey(paramString);
  }
  
  public void initCartesian(MotionKeyPosition paramMotionKeyPosition, MotionPaths paramMotionPaths1, MotionPaths paramMotionPaths2)
  {
    ...
    mMode = 0;
    x = ((int)(f10 * f11 + (f3 * f9 + x) - f4));
    y = ((int)(f11 * f1 + (f9 * f2 + y) - f8));
    mKeyFrameEasing = Easing.getInterpolator(mTransitionEasing);
    mPathMotionArc = mPathMotionArc;
  }
  
  public void initPath(MotionKeyPosition paramMotionKeyPosition, MotionPaths paramMotionPaths1, MotionPaths paramMotionPaths2)
  {
    float f1 = mFramePosition / 100.0F;
    time = f1;
    mDrawPath = mDrawPath;
  ...
  public void initPolar(int paramInt1, int paramInt2, MotionKeyPosition paramMotionKeyPosition, MotionPaths paramMotionPaths1, MotionPaths paramMotionPaths2)
  {
    float f1 = mFramePosition / 100.0F;
    time = f1;
    mDrawPath = mDrawPath;
  ...
  public void initScreen(int paramInt1, int paramInt2, MotionKeyPosition paramMotionKeyPosition, MotionPaths paramMotionPaths1, MotionPaths paramMotionPaths2)
  {
    float f1 = mFramePosition / 100.0F;
    time = f1;
    mDrawPath = mDrawPath;
  ...
  public void setDpDt(float paramFloat1, float paramFloat2, float[] paramArrayOfFloat, int[] paramArrayOfInt, double[] paramArrayOfDouble1, double[] paramArrayOfDouble2)
  {
    ...
    f2 = f1 - 0.0F * f3 / 2.0F;
    f5 -= 0.0F * f4 / 2.0F;
    paramArrayOfFloat[0] = ((f3 * 1.0F + f2) * paramFloat1 + (1.0F - paramFloat1) * f2 + 0.0F);
    paramArrayOfFloat[1] = ((f4 * 1.0F + f5) * paramFloat2 + (1.0F - paramFloat2) * f5 + 0.0F);
  }
  
  public void setView(float paramFloat, MotionWidget paramMotionWidget, int[] paramArrayOfInt, double[] paramArrayOfDouble1, double[] paramArrayOfDouble2, double[] paramArrayOfDouble3)
  {
    float f1 = x;
    float f2 = y;
    float f3 = width;
    ...
    if (paramArrayOfInt != null)
    {
      ...
      paramArrayOfInt.getCenter(paramFloat, paramArrayOfDouble3, paramArrayOfDouble1);
      f11 = paramArrayOfDouble3[0];
      paramFloat = paramArrayOfDouble3[1];
      f12 = paramArrayOfDouble1[0];
      f10 = paramArrayOfDouble1[1];
      double d2 = f11;
      d1 = f1;
      d3 = f2;
      f11 = (float)(Math.sin(d3) * d1 + d2 - f3 / 2.0F);
      ...
      double d7 = f7;
      f12 = (float)(d6 * d1 * d7 + (d5 * d2 + d4));
      d4 = f10;
      d5 = Math.cos(d3);
      f10 = (float)(Math.sin(d3) * d1 * d7 + (d4 - d5 * d2));
      ...
      {
        d1 = f5;
        paramMotionWidget.setRotationZ((float)(Math.toDegrees(Math.atan2(f10, f12)) + d1));
      }
    }
    else
    {
      ...
      if (!Float.isNaN(f5))
      {
        ...
        d1 = 0.0F;
        d3 = f5;
        paramMotionWidget.setRotationZ((float)(Math.toDegrees(Math.atan2(f11 + f7, paramFloat + f6)) + d3 + d1));
        paramFloat = f2;
        f11 = f1;
      }
    }
    ...
    i = (int)f11;
    paramFloat += 0.5F;
    paramMotionWidget.layout(i, (int)paramFloat, (int)(f11 + f3), (int)(paramFloat + f4));
  }
  ...
  public void setupRelative(Motion paramMotion, MotionPaths paramMotionPaths)
  {
    ...
    mRelativeToController = paramMotion;
