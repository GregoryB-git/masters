...
.field public static d:Lcom/google/firebase/messaging/o0;
...
.method public static synthetic a(Landroid/content/Context;Landroid/content/Intent;ZLV2/j;)LV2/j;
    .locals 0

    .line 1
    invoke-static {p0, p1, p2, p3}, Lcom/google/firebase/messaging/n;->j(Landroid/content/Context;Landroid/content/Intent;ZLV2/j;)LV2/j;
...
.method public static synthetic c(LV2/j;)Ljava/lang/Integer;
    .locals 0

    .line 1
    invoke-static {p0}, Lcom/google/firebase/messaging/n;->g(LV2/j;)Ljava/lang/Integer;
...
.method public static synthetic d(LV2/j;)Ljava/lang/Integer;
    .locals 0

    .line 1
    invoke-static {p0}, Lcom/google/firebase/messaging/n;->i(LV2/j;)Ljava/lang/Integer;
...
.method public static e(Landroid/content/Context;Landroid/content/Intent;Z)LV2/j;
    .locals 2
    ...
    .line 16
    .line 17
    invoke-static {p0, v0}, Lcom/google/firebase/messaging/n;->f(Landroid/content/Context;Ljava/lang/String;)Lcom/google/firebase/messaging/o0;
    ...
    .line 32
    .line 33
    invoke-static {p0, v0, p1}, Lcom/google/firebase/messaging/j0;->f(Landroid/content/Context;Lcom/google/firebase/messaging/o0;Landroid/content/Intent;)V
    ...
    .line 37
    :cond_1
    invoke-virtual {v0, p1}, Lcom/google/firebase/messaging/o0;->c(Landroid/content/Intent;)LV2/j;
    ...
    .line 63
    .line 64
    invoke-virtual {p0, p1, p2}, LV2/j;->g(Ljava/util/concurrent/Executor;LV2/b;)LV2/j;
...
.method public static f(Landroid/content/Context;Ljava/lang/String;)Lcom/google/firebase/messaging/o0;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/messaging/n;->d:Lcom/google/firebase/messaging/o0;
    ...
    sput-object v1, Lcom/google/firebase/messaging/n;->d:Lcom/google/firebase/messaging/o0;
    ...
    :cond_0
    :goto_0
    sget-object p0, Lcom/google/firebase/messaging/n;->d:Lcom/google/firebase/messaging/o0;
...
.method public static synthetic g(LV2/j;)Ljava/lang/Integer;
    .locals 0
...
.method public static synthetic i(LV2/j;)Ljava/lang/Integer;
    .locals 0
...
.method public static synthetic j(Landroid/content/Context;Landroid/content/Intent;ZLV2/j;)LV2/j;
    .locals 2
    ...
    .line 22
    :cond_0
    invoke-static {p0, p1, p2}, Lcom/google/firebase/messaging/n;->e(Landroid/content/Context;Landroid/content/Intent;Z)LV2/j;
...
# virtual methods
.method public k(Landroid/content/Intent;)LV2/j;
    .locals 3
    ...
    .line 23
    .line 24
    invoke-virtual {p0, v0, p1}, Lcom/google/firebase/messaging/n;->l(Landroid/content/Context;Landroid/content/Intent;)LV2/j;
...
.method public l(Landroid/content/Context;Landroid/content/Intent;)LV2/j;
    .locals 5
    ...
    .line 35
    .line 36
    invoke-static {p1, p2, v1}, Lcom/google/firebase/messaging/n;->e(Landroid/content/Context;Landroid/content/Intent;Z)LV2/j;
    ...
    .line 58
    .line 59
    invoke-virtual {v0, v2, v3}, LV2/j;->h(Ljava/util/concurrent/Executor;LV2/b;)LV2/j;
