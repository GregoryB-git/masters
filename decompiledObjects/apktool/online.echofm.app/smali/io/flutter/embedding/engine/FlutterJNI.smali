...
.field private deferredComponentManager:Lx5/a;
...
.field private localizationPlugin:LF5/e;
...
.field private platformMessageHandler:Lw5/f;
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0}, Lv5/d;->a(Ljava/nio/ByteBuffer;)Landroid/graphics/ImageDecoder$Source;
    ...
    invoke-direct {v0, p1, p2}, Lv5/i;-><init>(J)V

    invoke-static {p0, v0}, Lv5/e;->a(Landroid/graphics/ImageDecoder$Source;Landroid/graphics/ImageDecoder$OnHeaderDecodedListener;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2, p0}, Lt5/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lw5/f;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2}, Lw5/f;->e(ILjava/nio/ByteBuffer;)V
...
.method private static synthetic lambda$decodeImage$0(JLandroid/graphics/ImageDecoder;Landroid/graphics/ImageDecoder$ImageInfo;Landroid/graphics/ImageDecoder$Source;)V
    ...
    invoke-static {p4}, Lu5/o;->a(Landroid/graphics/ColorSpace$Named;)Landroid/graphics/ColorSpace;

    move-result-object p4

    invoke-static {p2, p4}, Lv5/f;->a(Landroid/graphics/ImageDecoder;Landroid/graphics/ColorSpace;)V

    const/4 p4, 0x1

    invoke-static {p2, p4}, Lv5/g;->a(Landroid/graphics/ImageDecoder;I)V

    invoke-static {p3}, Lv5/h;->a(Landroid/graphics/ImageDecoder$ImageInfo;)Landroid/util/Size;
...
.method public addIsDisplayingFlutterUiListener(Lio/flutter/embedding/engine/renderer/j;)V
    .locals 1
    .param p1    # Lio/flutter/embedding/engine/renderer/j;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:LF5/e;
    ...
    :cond_4
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:LF5/e;

    invoke-virtual {p1, v0}, LF5/e;->c(Ljava/util/List;)Ljava/util/Locale;
...
.method public dispatchEmptyPlatformMessage(Ljava/lang/String;I)V
    ...
    invoke-static {p2, p1}, Lt5/b;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method public dispatchSemanticsAction(ILio/flutter/view/i$g;)V
    .locals 1
    .param p2    # Lio/flutter/view/i$g;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    invoke-virtual {p0, p1, p2, v0}, Lio/flutter/embedding/engine/FlutterJNI;->dispatchSemanticsAction(ILio/flutter/view/i$g;Ljava/lang/Object;)V

    return-void
.end method

.method public dispatchSemanticsAction(ILio/flutter/view/i$g;Ljava/lang/Object;)V
    .locals 1
    .param p2    # Lio/flutter/view/i$g;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    sget-object v0, LE5/p;->a:LE5/p;

    invoke-virtual {v0, p3}, LE5/p;->a(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
    ...
    :goto_0
    iget p2, p2, Lio/flutter/view/i$g;->o:I
...
.method public getScaledFontSize(FI)F
    ...
    invoke-static {p2}, LD5/t;->b(I)Landroid/util/DisplayMetrics;
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
    ...
    invoke-interface/range {v0 .. v5}, Lw5/f;->g(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
...
.method public onDisplayOverlaySurface(IIIII)V
    ...
    invoke-virtual/range {v0 .. v5}, Lio/flutter/plugin/platform/r;->U(IIIII)V
...
.method public onDisplayPlatformView(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    iget-object v1, v0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Lio/flutter/plugin/platform/r;
    ...
    invoke-virtual/range {v1 .. v9}, Lio/flutter/plugin/platform/r;->V(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
...
.method public setDeferredComponentManager(Lx5/a;)V
    .locals 0
    ...
    .line 5
    .line 6
    invoke-interface {p1, p0}, Lx5/a;->a(Lio/flutter/embedding/engine/FlutterJNI;)V
...
.method public setLocalizationPlugin(LF5/e;)V
    .locals 0
    ...
    .line 3
    .line 4
    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:LF5/e;
...
.method public setPlatformMessageHandler(Lw5/f;)V
    .locals 0
    ...
    .line 3
    .line 4
    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lw5/f;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, p3}, LT5/d;->a(ZLjava/lang/Object;)V
