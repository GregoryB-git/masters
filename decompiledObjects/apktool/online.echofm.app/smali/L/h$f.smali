...
.method public constructor <init>(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)V
    ...
    .line 3
    .line 4
    iput-object p1, p0, LL/h$f;->a:Landroid/view/ActionMode$Callback;

    .line 5
    .line 6
    iput-object p2, p0, LL/h$f;->b:Landroid/widget/TextView;
...
.method public final b(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
    ...
    .line 1
    invoke-virtual {p0}, LL/h$f;->a()Landroid/content/Intent;
    ...
    .line 5
    invoke-virtual {p0, p2}, LL/h$f;->d(Landroid/widget/TextView;)Z
...
.method public final c(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    .line 35
    .line 36
    invoke-virtual {p0, v1, p1}, LL/h$f;->e(Landroid/content/pm/ResolveInfo;Landroid/content/Context;)Z
...
.method public final f(Landroid/view/Menu;)V
    ...
    .line 1
    iget-object v0, p0, LL/h$f;->b:Landroid/widget/TextView;
    ...
    .line 27
    iput-object v2, p0, LL/h$f;->c:Ljava/lang/Class;
    ...
    .line 39
    iput-object v2, p0, LL/h$f;->d:Ljava/lang/reflect/Method;

    .line 40
    .line 41
    iput-boolean v5, p0, LL/h$f;->e:Z
    :try_end_0
    ...
    .line 54
    .line 55
    iget-object v2, p0, LL/h$f;->c:Ljava/lang/Class;
    ...
    .line 62
    .line 63
    iget-object v2, p0, LL/h$f;->d:Ljava/lang/reflect/Method;
    ...
    .line 127
    :cond_3
    invoke-virtual {p0, v0, v1}, LL/h$f;->c(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    .line 154
    iget-object v7, p0, LL/h$f;->b:Landroid/widget/TextView;

    .line 155
    .line 156
    invoke-virtual {p0, v3, v7}, LL/h$f;->b(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
...
.method public onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    .line 1
    iget-object v0, p0, LL/h$f;->a:Landroid/view/ActionMode$Callback;
...
.method public onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    .line 1
    invoke-virtual {p0, p2}, LL/h$f;->f(Landroid/view/Menu;)V
