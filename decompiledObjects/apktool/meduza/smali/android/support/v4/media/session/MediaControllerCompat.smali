...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat;)V
    ...
    .line 12
    .line 13
    iget-object p2, p2, Landroid/support/v4/media/session/MediaSessionCompat;->a:Landroid/support/v4/media/session/MediaSessionCompat$d;
...
.method public static b(Landroid/app/Activity;Landroid/support/v4/media/session/MediaControllerCompat;)V
    .locals 2
...
# virtual methods
.method public final a(Lcom/ryanheise/audioservice/b$a;)V
    .locals 5
    ...
    .line 25
    .line 26
    invoke-virtual {p1, v0}, Landroid/support/v4/media/session/MediaControllerCompat$a;->b(Landroid/os/Handler;)V
    ...
    .line 32
    .line 33
    iget-object v3, p1, Landroid/support/v4/media/session/MediaControllerCompat$a;->a:Landroid/support/v4/media/session/MediaControllerCompat$a$a;
    ...
    .line 51
    .line 52
    invoke-direct {v2, p1}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21$a;-><init>(Landroid/support/v4/media/session/MediaControllerCompat$a;)V
    ...
    .line 59
    .line 60
    iput-object v2, p1, Landroid/support/v4/media/session/MediaControllerCompat$a;->c:Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21$a;
    :try_end_0
    ...
    .line 68
    invoke-interface {v1, v2}, Landroid/support/v4/media/session/IMediaSession;->G(Landroid/support/v4/media/session/IMediaControllerCallback;)V
    ...
    .line 72
    .line 73
    invoke-virtual {p1, v1, v3, v3}, Landroid/support/v4/media/session/MediaControllerCompat$a;->a(ILjava/lang/Object;Landroid/os/Bundle;)V
    :try_end_1
    ...
    .line 86
    :cond_1
    iput-object v3, p1, Landroid/support/v4/media/session/MediaControllerCompat$a;->c:Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21$a;
