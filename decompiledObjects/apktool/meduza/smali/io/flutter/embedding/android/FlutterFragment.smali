...
.field public final onBackPressedCallback:Lb/p;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/FlutterFragment;->onBackPressedCallback:Lb/p;

    new-instance v0, Landroid/os/Bundle;

    invoke-direct {v0}, Landroid/os/Bundle;-><init>()V

    invoke-virtual {p0, v0}, Lx0/i;->setArguments(Landroid/os/Bundle;)V
...
.method private stillAttachedForEvent(Ljava/lang/String;)Z
    ...
    .line 16
    invoke-virtual {p0}, Lx0/i;->hashCode()I
...
.method public bridge synthetic getActivity()Landroid/app/Activity;
    ...
    invoke-super {p0}, Lx0/i;->getActivity()Lx0/m;
...
.method public getBackCallbackState()Z
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/FlutterFragment;->onBackPressedCallback:Lb/p;

    invoke-virtual {v0}, Lb/p;->isEnabled()Z
...
.method public onAttach(Landroid/content/Context;)V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/FlutterFragment;->onBackPressedCallback:Lb/p;

    invoke-virtual {v0, p0, v1}, Lb/w;->a(Lb1/o;Lb/p;)V

    iget-object v0, p0, Lio/flutter/embedding/android/FlutterFragment;->onBackPressedCallback:Lb/p;

    invoke-virtual {v0, v2}, Lb/p;->setEnabled(Z)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1, v0}, Lb/p;->setEnabled(Z)V
...
.method public onDestroyView()V
    ...
    invoke-virtual {p0}, Lx0/i;->requireView()Landroid/view/View;
...
.method public onPause()V
    ...
    invoke-super {p0}, Lx0/i;->onPause()V
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-super {p0, p1, p2}, Lx0/i;->onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
...
.method public popSystemNavigator()Z
    ...
    invoke-virtual {v1}, Lb/p;->isEnabled()Z

    move-result v1

    if-eqz v1, :cond_0

    iget-object v3, p0, Lio/flutter/embedding/android/FlutterFragment;->onBackPressedCallback:Lb/p;

    invoke-virtual {v3, v2}, Lb/p;->setEnabled(Z)V
...
.method public setFrameworkHandlesBack(Z)V
    ...
    invoke-virtual {v0, p1}, Lb/p;->setEnabled(Z)V
