...
.method private copyAccessibilityFields(Landroid/view/accessibility/AccessibilityNodeInfo;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-static {p1}, La0/e;->a(Landroid/view/accessibility/AccessibilityNodeInfo;)I

    move-result v1

    invoke-static {p2, v1}, Lb0/f;->l(Landroid/view/accessibility/AccessibilityNodeInfo;I)V

    invoke-static {p1}, La0/d;->l(Landroid/view/accessibility/AccessibilityNodeInfo;)Z

    move-result v1

    invoke-static {p2, v1}, Lb0/f;->m(Landroid/view/accessibility/AccessibilityNodeInfo;Z)V
    ...
    invoke-static {p1}, Lio/flutter/view/a;->a(Landroid/view/accessibility/AccessibilityNodeInfo;)Ljava/util/List;

    move-result-object v0

    invoke-static {p2, v0}, Lc0/b;->v(Landroid/view/accessibility/AccessibilityNodeInfo;Ljava/util/List;)V

    invoke-static {p1}, Ld2/e;->l(Landroid/view/accessibility/AccessibilityNodeInfo;)Ljava/lang/CharSequence;

    move-result-object v0

    invoke-static {p2, v0}, Lio/flutter/view/a;->b(Landroid/view/accessibility/AccessibilityNodeInfo;Ljava/lang/CharSequence;)V

    invoke-static {p1}, Lio/flutter/view/a;->c(Landroid/view/accessibility/AccessibilityNodeInfo;)Z

    move-result p1

    invoke-static {p2, p1}, Lc0/b;->w(Landroid/view/accessibility/AccessibilityNodeInfo;Z)V
