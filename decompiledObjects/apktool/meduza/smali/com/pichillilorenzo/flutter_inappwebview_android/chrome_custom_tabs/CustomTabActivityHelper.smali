...
# instance fields
.field private mClient:Lp/n;

.field private mConnection:Lp/p;
...
.field private mCustomTabsCallback:Lp/b;

.field private mCustomTabsSession:Lp/u;
...
.method public static openCustomTab(Landroid/app/Activity;Lp/o;Landroid/net/Uri;Ljava/util/Map;Landroid/net/Uri;I)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static openTrustedWebActivity(Landroid/app/Activity;Lq/b;Landroid/net/Uri;Ljava/util/Map;Landroid/net/Uri;I)V
    ...
    .line 1
    iget-object v1, p1, Lq/b;->a:Landroid/content/Intent;
...
.method public bindCustomTabsService(Landroid/app/Activity;)Z
    ...
    iget-object v0, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/CustomTabActivityHelper;->mClient:Lp/n;
    ...
    iput-object v1, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/CustomTabActivityHelper;->mConnection:Lp/p;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v2

    invoke-virtual {v1, v2}, Lp/p;->setApplicationContext(Landroid/content/Context;)V
...
.method public getSession()Lp/u;
    ...
    .line 6
    :cond_0
    iget-object v1, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/CustomTabActivityHelper;->mCustomTabsSession:Lp/u;
    ...
    .line 9
    .line 10
    iget-object v1, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/CustomTabActivityHelper;->mCustomTabsCallback:Lp/b;
    ...
    .line 13
    .line 14
    invoke-direct {v2, v1}, Lp/m;-><init>(Lp/b;)V

    .line 15
    .line 16
    .line 17
    :try_start_0
    iget-object v1, v0, Lp/n;->a:Landroid/support/customtabs/ICustomTabsService;

    .line 18
    .line 19
    invoke-interface {v1, v2}, Landroid/support/customtabs/ICustomTabsService;->T1(Landroid/support/customtabs/ICustomTabsCallback;)Z
    ...
    .line 27
    .line 28
    iget-object v3, v0, Lp/n;->a:Landroid/support/customtabs/ICustomTabsService;

    .line 29
    .line 30
    iget-object v0, v0, Lp/n;->b:Landroid/content/ComponentName;

    .line 31
    .line 32
    invoke-direct {v1, v3, v2, v0}, Lp/u;-><init>(Landroid/support/customtabs/ICustomTabsService;Lp/m;Landroid/content/ComponentName;)V
    ...
    .line 37
    :goto_1
    iput-object v1, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/CustomTabActivityHelper;->mCustomTabsSession:Lp/u;

    .line 38
    .line 39
    :cond_2
    iget-object v0, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/CustomTabActivityHelper;->mCustomTabsSession:Lp/u;
...
.method public mayLaunchUrl(Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/CustomTabActivityHelper;->getSession()Lp/u;
    ...
    :cond_1
    invoke-virtual {v0, p2}, Lp/u;->a(Landroid/os/Bundle;)Landroid/os/Bundle;

    move-result-object p2

    :try_start_0
    iget-object v2, v0, Lp/u;->b:Landroid/support/customtabs/ICustomTabsService;

    iget-object v0, v0, Lp/u;->c:Landroid/support/customtabs/ICustomTabsCallback;

    invoke-interface {v2, v0, p1, p2, p3}, Landroid/support/customtabs/ICustomTabsService;->T(Landroid/support/customtabs/ICustomTabsCallback;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
...
.method public onServiceConnected(Lp/n;)V
    .locals 2

    .line 1
    iput-object p1, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/CustomTabActivityHelper;->mClient:Lp/n;
    ...
    .line 6
    :try_start_0
    iget-object p1, p1, Lp/n;->a:Landroid/support/customtabs/ICustomTabsService;
    ...
    .line 9
    .line 10
    invoke-interface {p1, v0, v1}, Landroid/support/customtabs/ICustomTabsService;->g1(J)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onServiceDisconnected()V
    ...
    iput-object v0, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/CustomTabActivityHelper;->mClient:Lp/n;

    iput-object v0, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/CustomTabActivityHelper;->mCustomTabsSession:Lp/u;
...
.method public setCustomTabsCallback(Lp/b;)V
    .locals 0

    iput-object p1, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/CustomTabActivityHelper;->mCustomTabsCallback:Lp/b;
...
.method public unbindCustomTabsService(Landroid/app/Activity;)V
    ...
    iget-object v0, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/CustomTabActivityHelper;->mConnection:Lp/p;
    ...
    iput-object p1, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/CustomTabActivityHelper;->mCustomTabsSession:Lp/u;

    iput-object p1, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/CustomTabActivityHelper;->mConnection:Lp/p;
