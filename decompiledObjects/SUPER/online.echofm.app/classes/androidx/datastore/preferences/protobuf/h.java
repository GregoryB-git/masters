...
public abstract class h
{
  ...
  public static h g(InputStream paramInputStream, int paramInt)
  {
    if (paramInt > 0)
    {
  ...
  public static h h(byte[] paramArrayOfByte)
  {
    return i(paramArrayOfByte, 0, paramArrayOfByte.length);
  }
  
  public static h i(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    return j(paramArrayOfByte, paramInt1, paramInt2, false);
  }
  
  public static h j(byte[] paramArrayOfByte, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    extends h
  {
    ...
    public byte[] G(int paramInt)
    {
      if (paramInt > 0)
      {
        ...
        if (paramInt <= i1 - i2)
        {
          paramInt += i2;
          j = paramInt;
          return Arrays.copyOfRange(f, i2, paramInt);
        }
      }
      if (paramInt <= 0)
      {
    ...
    public long K()
    {
      ...
      if (i2 != i1)
      {
        ...
        if (i2 - i3 >= 9)
        {
          ...
          label320:
          i4 = i1 + 9;
          l1 = l2 ^ arrayOfByte[i3] << 56 ^ 0xFE03F80FE03F80;
          i2 = i4;
          if (l1 >= 0L) {
            break label373;
          }
          if (arrayOfByte[i4] >= 0L) {
            break label368;
          }
        }
      }
    ...
    public String z()
    {
      ...
      if (i1 > 0)
      {
        ...
        if (i1 <= i2 - i3)
        {
          String str = new String(f, i3, i1, y.a);
          j += i1;
          return str;
        }
      }
