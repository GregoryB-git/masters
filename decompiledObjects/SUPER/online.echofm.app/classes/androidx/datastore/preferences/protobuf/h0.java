  ...
  extends AbstractMap
{
  ...
  public static h0 q(int paramInt)
  {
  ...
  public boolean equals(Object paramObject)
  {
    ...
    int i = size();
    if (i != ((h0)paramObject).size()) {
      return false;
    }
    int j = k();
    if (j != ((h0)paramObject).k()) {
      return entrySet().equals(((h0)paramObject).entrySet());
    }
    for (int k = 0; k < j; k++) {
      if (!j(k).equals(((h0)paramObject).j(k))) {
        return false;
      }
    }
    if (j != i) {
  ...
  public final int f(Comparable paramComparable)
  {
    ...
    for (j = i + 1;; j = i + 1)
    {
      ...
      {
        int m = (i + j) / 2;
        k = paramComparable.compareTo(((e)p.get(m)).h());
        if (k < 0) {
          j = m - 1;
        } else if (k > 0) {
          i = m + 1;
  ...
  public Object r(Comparable paramComparable, Object paramObject)
  {
    ...
    if (k == i)
    {
      e locale = (e)p.remove(i - 1);
      n().put(locale.h(), locale.getValue());
    }
    p.add(j, new e(paramComparable, paramObject));
    return null;
  }
  ...
  public class b
    implements Iterator
  {
    public int o = h0.b(h0.this).size();
    public Iterator p;
    ...
    {
      if (p == null) {
        p = h0.e(h0.this).entrySet().iterator();
      }
      return p;
    }
    ...
    public boolean hasNext()
    {
      int i = o;
      boolean bool;
      if (((i > 0) && (i <= h0.b(h0.this).size())) || (b().hasNext())) {
        bool = true;
      } else {
        bool = false;
      }
    ...
    implements Iterator
  {
    ...
    {
      if (q == null) {
        q = h0.c(h0.this).entrySet().iterator();
      }
      return q;
    }
    ...
    public Map.Entry d()
    {
      ...
      int i = o + 1;
      o = i;
      if (i < h0.b(h0.this).size()) {}
      for (Object localObject = h0.b(h0.this).get(o);; localObject = b().next()) {
        return (Map.Entry)localObject;
      }
    }
    ...
    public boolean hasNext()
    {
      ...
      boolean bool1 = true;
      boolean bool2 = bool1;
      if (i + 1 >= h0.b(h0.this).size()) {
        if ((!h0.c(h0.this).isEmpty()) && (b().hasNext())) {
          bool2 = bool1;
        } else {
          bool2 = false;
        }
...
/* Location:
 * Qualified Name:     androidx.datastore.preferences.protobuf.h0
