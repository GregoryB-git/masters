  ...
  extends b
{
  ...
  public static G a(I.a parama, r3.b paramb, Integer paramInteger)
  {
    I.a locala = I.a.d;
    ...
    {
      parama = I.a(parama);
      return new G(parama, paramb, b(parama, paramInteger), paramInteger);
    }
    parama = new StringBuilder();
    parama.append("XChaCha20Poly1305 key must be constructed with key of length 32 bytes, not ");
    parama.append(paramb.b());
    throw new GeneralSecurityException(parama.toString());
  }
  
  public static a b(I paramI, Integer paramInteger)
  {
    if (paramI.b() == I.a.d) {
