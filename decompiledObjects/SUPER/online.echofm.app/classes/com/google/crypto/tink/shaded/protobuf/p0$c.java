  ...
  public static int f(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    for (;;)
    {
      ...
      if (paramInt1 < 0)
      {
        ...
        {
          if (j >= paramInt2 - 1) {
            return p0.c(paramArrayOfByte, j, paramInt2);
          }
  ...
  public String a(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    if ((paramInt1 | paramInt2 | paramArrayOfByte.length - paramInt1 - paramInt2) >= 0)
    {
      ...
      for (paramInt2 = 0; paramInt1 < i; paramInt2++)
      {
        ...
        paramInt1++;
        p0.a.c(b1, arrayOfChar, paramInt2);
      }
      while (paramInt1 < i)
      {
        int j = paramInt1 + 1;
        ...
        if (p0.a.b(b1))
        {
          ...
          while (paramInt2 < i)
          {
            ...
            paramInt2++;
            p0.a.c(b1, arrayOfChar, paramInt1);
            paramInt1++;
          }
          j = paramInt1;
          paramInt1 = paramInt2;
        ...
        else if (p0.a.d(b1))
        {
          ...
          {
            paramInt1 += 2;
            p0.a.e(b1, paramArrayOfByte[j], arrayOfChar, paramInt2);
            paramInt2++;
          }
          else
          {
        ...
        else
        {
          ...
          if (p0.a.f(b1))
          {
            if (j < i - 1)
            {
              ...
              j = paramInt1 + 3;
              p0.a.g(b1, b2, paramArrayOfByte[(paramInt1 + 2)], arrayOfChar, paramInt2);
              paramInt2++;
              paramInt1 = j;
            }
            else
          ...
          else if (j < i - 2)
          {
            ...
            j = paramInt1 + 4;
            p0.a.a(b1, b2, b3, paramArrayOfByte[(paramInt1 + 3)], arrayOfChar, paramInt2);
            paramInt2 += 2;
            paramInt1 = j;
          }
          else
...
/* Location:
 * Qualified Name:     com.google.crypto.tink.shaded.protobuf.p0.c
