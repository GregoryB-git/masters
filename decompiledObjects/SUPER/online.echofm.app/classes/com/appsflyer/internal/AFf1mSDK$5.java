...
final class AFf1mSDK$5
  extends AFb1hSDK<Map<String, Object>>
{
  public AFf1mSDK$5(AFf1mSDK paramAFf1mSDK, Context paramContext, AFc1xSDK paramAFc1xSDK, String paramString, String... paramVarArgs)
  {
  ...
  private static void AFInAppEventParameterName(String paramString, Map<String, Object> paramMap, Cursor paramCursor)
  {
    ...
    paramMap.put(paramString, paramCursor);
  }
  
  private static void AFKeystoreWrapper(String paramString, Map<String, Object> paramMap, Cursor paramCursor)
  {
    int i = paramCursor.getColumnIndex(paramString);
    if (i == -1) {
      return;
    ...
    paramMap.put(paramString, Long.valueOf(l));
  }
}

/* Location:
 * Qualified Name:     com.appsflyer.internal.AFf1mSDK.5
