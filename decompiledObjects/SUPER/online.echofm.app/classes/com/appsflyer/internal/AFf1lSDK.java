  ...
  extends AFf1pSDK
{
  ...
  public AFf1lSDK(ProviderInfo paramProviderInfo, Runnable paramRunnable, AFc1xSDK paramAFc1xSDK)
  {
    super("af_referrer", authority, paramRunnable);
    valueOf = paramAFc1xSDK;
    AFInAppEventType = paramProviderInfo;
  }
  
  /* Error */
  public static android.content.ContentProviderClient valueOf(Context paramContext, android.net.Uri paramUri)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 37	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   4: aload_1
    //   5: invokevirtual 43	android/content/ContentResolver:acquireUnstableContentProviderClient	(Landroid/net/Uri;)Landroid/content/ContentProviderClient;
    //   8: astore_0
    //   9: goto +31 -> 40
    //   12: astore_0
    //   13: goto +7 -> 20
    ...
    //   24: aload_0
    //   25: iconst_0
    //   26: invokestatic 51	com/appsflyer/AFLogger:afErrorLog	(Ljava/lang/String;Ljava/lang/Throwable;Z)V
    //   29: goto +9 -> 38
    //   32: ldc 53
    //   34: astore_1
    //   35: goto -12 -> 23
    ...
    //   0	42	1	paramUri	android.net.Uri
    // Exception table:
    //   from	to	target	type
    //   0	9	12	finally
    //   0	9	16	java/lang/SecurityException
  }
  ...
  public final void valueOf(final Context paramContext)
  {
    ...
    valueOf.AFInAppEventType().execute(paramContext);
  }
}

/* Location:
 * Qualified Name:     com.appsflyer.internal.AFf1lSDK
