...
public abstract class j
{
  ...
  public static StringBuilder b(int paramInt)
  {
    i.b(paramInt, "size");
    return new StringBuilder((int)Math.min(paramInt * 8L, 1073741824L));
  }
  
  public static boolean c(Collection paramCollection, Object paramObject)
  {
    m.j(paramCollection);
    try
    {
    ...
    extends AbstractCollection
  {
    ...
    public a(Collection paramCollection, n paramn)
    {
      o = paramCollection;
      p = paramn;
    }
