...
public final class SharedPreferencesPlugin$getAll$1 extends wb.i implements p<d0, ub.e<? super Map<String, ? extends Object>>, Object> {
    public final /* synthetic */ List<String> $allowList;
    public int label;
    public final /* synthetic */ SharedPreferencesPlugin this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SharedPreferencesPlugin$getAll$1(SharedPreferencesPlugin sharedPreferencesPlugin, List<String> list, ub.e<? super SharedPreferencesPlugin$getAll$1> eVar) {
        super(2, eVar);
    ...
    public final Object invoke(d0 d0Var, ub.e<? super Map<String, ? extends Object>> eVar) {
        return ((SharedPreferencesPlugin$getAll$1) create(d0Var, eVar)).invokeSuspend(rb.h.f13851a);
    }
