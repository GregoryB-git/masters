...
@wb.e(c = "io.flutter.plugins.sharedpreferences.SharedPreferencesPlugin$getString$1", f = "SharedPreferencesPlugin.kt", l = {180}, m = "invokeSuspend")
/* loaded from: classes.dex */
public final class SharedPreferencesPlugin$getString$1 extends wb.i implements p<d0, ub.e<? super rb.h>, Object> {
    public final /* synthetic */ String $key;
    public final /* synthetic */ s<String> $value;
    public Object L$0;
    public int label;
    public final /* synthetic */ SharedPreferencesPlugin this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SharedPreferencesPlugin$getString$1(String str, SharedPreferencesPlugin sharedPreferencesPlugin, s<String> sVar, ub.e<? super SharedPreferencesPlugin$getString$1> eVar) {
        super(2, eVar);
        this.$key = str;
    ...
    public final Object invoke(d0 d0Var, ub.e<? super rb.h> eVar) {
        return ((SharedPreferencesPlugin$getString$1) create(d0Var, eVar)).invokeSuspend(rb.h.f13851a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            ...
            qc.e<String> eVar = new qc.e<String>() { // from class: io.flutter.plugins.sharedpreferences.SharedPreferencesPlugin$getString$1$invokeSuspend$$inlined$map$1
                ...
                public static final class AnonymousClass2<T> implements qc.f {
                    ...
                    @wb.e(c = "io.flutter.plugins.sharedpreferences.SharedPreferencesPlugin$getString$1$invokeSuspend$$inlined$map$1$2", f = "SharedPreferencesPlugin.kt", l = {223}, m = "emit")
                    ...
                    */
                    public final java.lang.Object emit(java.lang.Object r5, ub.e r6) {
                        ...
                        L45:
                            ...
                            return r5
                        */
                        throw new UnsupportedOperationException("Method not decompiled: io.flutter.plugins.sharedpreferences.SharedPreferencesPlugin$getString$1$invokeSuspend$$inlined$map$1.AnonymousClass2.emit(java.lang.Object, ub.e):java.lang.Object");
                    }
                }

                @Override // qc.e
                public Object collect(qc.f<? super String> fVar, ub.e eVar2) {
                    Object collect = qc.e.this.collect(new AnonymousClass2(fVar, u02), eVar2);
                    return collect == vb.a.f16085a ? collect : rb.h.f13851a;
                }
            };
            s<String> sVar2 = this.$value;
            this.L$0 = sVar2;
            this.label = 1;
