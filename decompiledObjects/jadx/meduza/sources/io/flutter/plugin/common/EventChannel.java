        ...
        private void onCancel(Object obj, BinaryMessenger.BinaryReply binaryReply) {
            ...
            if (this.activeSink.getAndSet(null) != null) {
                try {
                    ...
                    StringBuilder l10 = f.l(EventChannel.TAG);
                    l10.append(EventChannel.this.name);
                    Log.e(l10.toString(), "Failed to close event stream", e10);
                    encodeErrorEnvelope = EventChannel.this.codec.encodeErrorEnvelope("error", e10.getMessage(), null);
                }
            } else {
                encodeErrorEnvelope = EventChannel.this.codec.encodeErrorEnvelope("error", "No active stream to cancel", null);
            }
        ...
        private void onListen(Object obj, BinaryMessenger.BinaryReply binaryReply) {
            ...
            if (this.activeSink.getAndSet(eventSinkImplementation) != null) {
                try {
                    ...
                    StringBuilder l10 = f.l(EventChannel.TAG);
                    l10.append(EventChannel.this.name);
                    Log.e(l10.toString(), "Failed to close existing event stream", e10);
                }
            }
            try {
