    ...
    public Object readValueOfType(byte b10, ByteBuffer byteBuffer) {
        ...
        switch (b10) {
            ...
            case 9:
                ...
                int[] iArr4 = new int[readSize];
                readAlignment(byteBuffer, 4);
                byteBuffer.asIntBuffer().get(iArr4);
                iArr3 = iArr4;
                position = (readSize * 4) + byteBuffer.position();
                iArr2 = iArr3;
            ...
            case 10:
                ...
                iArr = jArr;
                position = (readSize2 * 8) + byteBuffer.position();
                iArr2 = iArr;
                byteBuffer.position(position);
                return iArr2;
            case 11:
    ...
    public void writeValue(ByteArrayOutputStream byteArrayOutputStream, Object obj) {
        ...
        if (obj instanceof Number) {
            ...
            if ((obj instanceof Float) || (obj instanceof Double)) {
                ...
                StringBuilder l10 = f.l("Unsupported Number type: ");
