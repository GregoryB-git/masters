...
public class PullToRefreshLayout extends e implements Disposable {
    ...
    public void prepare() {
        ...
        setOnChildScrollUpCallback(new e.i() { // from class: com.pichillilorenzo.flutter_inappwebview_android.pull_to_refresh.PullToRefreshLayout.1
            @Override // y1.e.i
            public boolean canChildScrollUp(e eVar, View view) {
        ...
        setOnRefreshListener(new e.j() { // from class: com.pichillilorenzo.flutter_inappwebview_android.pull_to_refresh.PullToRefreshLayout.2
            @Override // y1.e.j
