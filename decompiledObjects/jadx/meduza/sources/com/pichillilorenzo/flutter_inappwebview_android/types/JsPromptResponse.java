...
public class JsPromptResponse {
    ...
    public String toString() {
        StringBuilder l10 = f.l("JsPromptResponse{message='");
        j.s(l10, this.message, '\'', ", defaultValue='");
        j.s(l10, this.defaultValue, '\'', ", confirmButtonTitle='");
        j.s(l10, this.confirmButtonTitle, '\'', ", cancelButtonTitle='");
        j.s(l10, this.cancelButtonTitle, '\'', ", handledByClient=");
        l10.append(this.handledByClient);
        l10.append(", value='");
        j.s(l10, this.value, '\'', ", action=");
