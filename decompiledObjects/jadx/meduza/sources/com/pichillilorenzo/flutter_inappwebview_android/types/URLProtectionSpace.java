...
public class URLProtectionSpace {
    ...
    public int hashCode() {
        int e10 = j.e(this.protocol, this.host.hashCode() * 31, 31);
        String str = this.realm;
        int hashCode = (((e10 + (str != null ? str.hashCode() : 0)) * 31) + this.port) * 31;
        SslCertificate sslCertificate = this.sslCertificate;
    ...
    public String toString() {
        StringBuilder l10 = f.l("URLProtectionSpace{host='");
        j.s(l10, this.host, '\'', ", protocol='");
        j.s(l10, this.protocol, '\'', ", realm='");
        j.s(l10, this.realm, '\'', ", port=");
        l10.append(this.port);
        l10.append(", sslCertificate=");
        l10.append(this.sslCertificate);
        l10.append(", sslError=");
        l10.append(this.sslError);
        l10.append('}');
        return l10.toString();
    }
}
