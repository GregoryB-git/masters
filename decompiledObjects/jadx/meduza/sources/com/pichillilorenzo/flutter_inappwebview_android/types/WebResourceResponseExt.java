...
public class WebResourceResponseExt {
    ...
    public String toString() {
        StringBuilder l10 = f.l("WebResourceResponseExt{contentType='");
        j.s(l10, this.contentType, '\'', ", contentEncoding='");
        j.s(l10, this.contentEncoding, '\'', ", statusCode=");
        l10.append(this.statusCode);
        l10.append(", reasonPhrase='");
        j.s(l10, this.reasonPhrase, '\'', ", headers=");
