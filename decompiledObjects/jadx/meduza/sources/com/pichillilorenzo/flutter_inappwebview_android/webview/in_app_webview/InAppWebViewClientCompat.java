...
public class InAppWebViewClientCompat extends WebViewClientCompat {
    ...
    public static /* synthetic */ class AnonymousClass7 {
        public static final /* synthetic */ int[] $SwitchMap$com$pichillilorenzo$flutter_inappwebview_android$types$NavigationActionPolicy;
    ...
    public void onFormResubmission(final WebView webView, final Message message, final Message message2) {
        ...
        WebViewChannelDelegate.FormResubmissionCallback formResubmissionCallback = new WebViewChannelDelegate.FormResubmissionCallback() { // from class: com.pichillilorenzo.flutter_inappwebview_android.webview.in_app_webview.InAppWebViewClientCompat.6
            ...
            public void error(String str, String str2, Object obj) {
                ...
                j.t(g10, str2, InAppWebViewClientCompat.LOG_TAG);
    ...
    public void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, l lVar) {
        ...
        if (webResourceRequest.isForMainFrame()) {
            ...
            if (this.inAppBrowserDelegate != null) {
                ...
                this.inAppBrowserDelegate.didFailNavigation(webResourceRequest.getUrl().toString(), i10, str);
            }
        }
        WebViewChannelDelegate webViewChannelDelegate = inAppWebView.channelDelegate;
        if (webViewChannelDelegate != null) {
            webViewChannelDelegate.onReceivedError(WebResourceRequestExt.fromWebResourceRequest(webResourceRequest), WebResourceErrorExt.fromWebResourceError(lVar));
        }
    }
    ...
    */
    public void onReceivedSslError(final android.webkit.WebView r11, final android.webkit.SslErrorHandler r12, final android.net.http.SslError r13) {
        /*
            ...
            r3.<init>(r1)     // Catch: java.net.URISyntaxException -> L1c
            java.lang.String r1 = r3.getHost()     // Catch: java.net.URISyntaxException -> L1c
            java.lang.String r2 = r3.getScheme()     // Catch: java.net.URISyntaxException -> L1a
            int r0 = r3.getPort()     // Catch: java.net.URISyntaxException -> L1a
            goto L24
        L1a:
            r3 = move-exception
            goto L1e
    ...
    @Override // androidx.webkit.WebViewClientCompat
    public void onSafeBrowsingHit(final WebView webView, final WebResourceRequest webResourceRequest, final int i10, final d dVar) {
        WebViewChannelDelegate.SafeBrowsingHitCallback safeBrowsingHitCallback = new WebViewChannelDelegate.SafeBrowsingHitCallback() { // from class: com.pichillilorenzo.flutter_inappwebview_android.webview.in_app_webview.InAppWebViewClientCompat.5
            ...
            public void defaultBehaviour(SafeBrowsingResponse safeBrowsingResponse) {
                InAppWebViewClientCompat.super.onSafeBrowsingHit(webView, webResourceRequest, i10, dVar);
            }
            ...
            public boolean nonNullSuccess(SafeBrowsingResponse safeBrowsingResponse) {
                ...
                if (action != null) {
                    ...
                    if (intValue != 0) {
                        ...
                        if (!b.c0("SAFE_BROWSING_RESPONSE_PROCEED")) {
                            return true;
                        }
                        v vVar = (v) dVar;
                        vVar.getClass();
                        a.f fVar = i0.f3379q;
                        if (fVar.c()) {
                            d2.j.c(vVar.c(), isReport);
                            return false;
                        }
                        if (!fVar.d()) {
                            throw i0.a();
                        }
                        vVar.b().proceed(isReport);
                        return false;
                    }
                    if (b.c0("SAFE_BROWSING_RESPONSE_BACK_TO_SAFETY")) {
                        ...
                        a.f fVar2 = i0.f3378p;
                        if (fVar2.c()) {
                            d2.j.a(vVar2.c(), isReport);
                            return false;
                        }
                        if (!fVar2.d()) {
                            throw i0.a();
                        }
                        vVar2.b().backToSafety(isReport);
                        return false;
                    }
                }
                return true;
    ...
    public void onScaleChanged(WebView webView, float f, float f10) {
        ...
        InAppWebView inAppWebView = (InAppWebView) webView;
        inAppWebView.zoomScale = f10 / Util.getPixelDensity(inAppWebView.getContext());
        WebViewChannelDelegate webViewChannelDelegate = inAppWebView.channelDelegate;
        if (webViewChannelDelegate != null) {
            webViewChannelDelegate.onZoomScaleChanged(f, f10);
        }
    }
    ...
    public void onShouldOverrideUrlLoading(final InAppWebView inAppWebView, final String str, String str2, final Map<String, String> map, final boolean z10, boolean z11, boolean z12) {
        ...
        WebViewChannelDelegate.ShouldOverrideUrlLoadingCallback shouldOverrideUrlLoadingCallback = new WebViewChannelDelegate.ShouldOverrideUrlLoadingCallback() { // from class: com.pichillilorenzo.flutter_inappwebview_android.webview.in_app_webview.InAppWebViewClientCompat.1
            ...
            public void error(String str3, String str4, Object obj) {
                ...
                j.t(g10, str4, InAppWebViewClientCompat.LOG_TAG);
    ...
    */
    public boolean shouldOverrideUrlLoading(android.webkit.WebView r9, android.webkit.WebResourceRequest r10) {
        /*
            ...
            boolean r0 = x6.b.c0(r0)
            if (r0 == 0) goto L1b
            boolean r0 = c2.m.a(r10)
        L19:
            r7 = r0
            goto L27
        L1b:
