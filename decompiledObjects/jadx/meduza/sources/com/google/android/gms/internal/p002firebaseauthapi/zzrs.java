...
public final class zzrs {
    ...
    public static zzqs zzb(zzpm zzpmVar) {
        if (!zzpmVar.zza().zzf().equals("type.googleapis.com/google.crypto.tink.HmacKey")) {
            throw new IllegalArgumentException(f.j("Wrong type URL in call to HmacProtoSerialization.parseParameters: ", zzpmVar.zza().zzf()));
        }
        try {
            ...
            throw new GeneralSecurityException(j.g("Parsing HmacParameters failed: unknown Version ", zza2.zzb()));
        } catch (zzakm e10) {
