...
public final class zzadr {
    ...
    public static o zza(FirebaseAuth firebaseAuth, zzzs zzzsVar, r rVar) {
        List list;
        ...
        List<x> zzc = zzzsVar.zzc();
        ArrayList arrayList = new ArrayList();
        for (x xVar : zzc) {
            if (xVar instanceof h0) {
                arrayList.add((h0) xVar);
            }
        }
        List<x> zzc2 = zzzsVar.zzc();
        ArrayList arrayList2 = new ArrayList();
        for (x xVar2 : zzc2) {
            if (xVar2 instanceof l0) {
                arrayList2.add((l0) xVar2);
            }
        }
        List<x> zzc3 = zzzsVar.zzc();
        String zzb = zzzsVar.zzb();
        j.i(zzc3);
        j.e(zzb);
        n nVar = new n();
        nVar.f2492c = new ArrayList();
        nVar.f2493d = new ArrayList();
        for (x xVar3 : zzc3) {
            if (xVar3 instanceof h0) {
                list = nVar.f2492c;
                parcelable = (h0) xVar3;
            } else {
                if (!(xVar3 instanceof l0)) {
                    throw new IllegalArgumentException(f.j("MultiFactorInfo must be either PhoneMultiFactorInfo or TotpMultiFactorInfo. The factorId of this MultiFactorInfo: ", xVar3.E()));
                }
                list = nVar.f2493d;
                parcelable = (l0) xVar3;
            }
        ...
        fVar.a();
        return new o(str, str2, new m(arrayList, nVar, fVar.f15085b, zzzsVar.zza(), (i) rVar, arrayList2));
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof l) {
            return ((l) exc).f2106a.endsWith("APP_NOT_AUTHORIZED");
        }
        return false;
    }
    ...
    public static boolean zzc(Exception exc) {
        if (exc instanceof l) {
            return ((l) exc).f2106a.endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzd(Exception exc) {
        if (exc instanceof l) {
            return ((l) exc).f2106a.endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }

    private static String zza(String str, Status status) {
        return TextUtils.isEmpty(status.f2817b) ? str : String.format(g.d(str, " [ %s ]"), status.f2817b);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:51:0x00d8 A[FALL_THROUGH] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static u7.h zza(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instructions count: 552
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzadr.zza(com.google.android.gms.common.api.Status):u7.h");
    }

    public static h zza(Status status, b8.f fVar, String str, String str2) {
        int i10 = status.f2816a;
        if (i10 == 17012 || i10 == 17007 || i10 == 17025) {
            p pVar = new p(zza(i10), zza(zzb(i10), status));
            pVar.f2123b = fVar;
            pVar.f2124c = str;
            return pVar;
        }
    ...
    public static boolean zza(Exception exc) {
        if (exc instanceof l) {
            return ((l) exc).f2106a.endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }
}
