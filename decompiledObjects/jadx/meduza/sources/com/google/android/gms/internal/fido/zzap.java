...
public final class zzap {
    public static int zza(int i10, int i11, String str) {
        ...
        if (i10 < 0) {
            zza = zzaq.zza("%s (%s) must not be negative", "index", Integer.valueOf(i10));
        } else {
            if (i11 < 0) {
                throw new IllegalArgumentException(f.h("negative size: ", i11));
            }
            zza = zzaq.zza("%s (%s) must be less than size (%s)", "index", Integer.valueOf(i10), Integer.valueOf(i11));
        }
