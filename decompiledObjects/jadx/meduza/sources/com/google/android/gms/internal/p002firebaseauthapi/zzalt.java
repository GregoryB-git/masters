...
final class zzalt<T> implements zzamc<T> {
    ...
    public final T zza() {
        ...
        return zzalnVar instanceof zzakg ? (T) ((zzakg) zzalnVar).zzo() : (T) zzalnVar.zzq().zzf();
    }
    ...
    */
    public final void zza(T r12, com.google.android.gms.internal.p002firebaseauthapi.zzamd r13, com.google.android.gms.internal.p002firebaseauthapi.zzajv r14) {
        ...
        L85:
            ...
            return
        L8b:
            com.google.android.gms.internal.firebase-auth-api.zzakm r13 = com.google.android.gms.internal.p002firebaseauthapi.zzakm.zzb()     // Catch: java.lang.Throwable -> L90
    ...
    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzamc
    public final void zza(T t, zzanm zzanmVar) {
        ...
        while (zzd.hasNext()) {
            ...
            zzanmVar.zza(zzakaVar.zza(), next instanceof zzakq ? ((zzakq) next).zza().zzb() : next.getValue());
        }
        zzamv<?, ?> zzamvVar = this.zzb;
    ...
    public final void zza(T t, T t10) {
        zzame.zza(this.zzb, t, t10);
        if (this.zzc) {
            zzame.zza(this.zzd, t, t10);
        }
    }
