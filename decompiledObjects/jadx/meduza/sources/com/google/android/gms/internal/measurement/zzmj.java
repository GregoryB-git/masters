...
class zzmj<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    private final int zza(K k10) {
        int i10 = this.zzb - 1;
        if (i10 >= 0) {
            int compareTo = k10.compareTo((Comparable) ((zzmn) this.zza[i10]).getKey());
            if (compareTo > 0) {
                return -(i10 + 2);
            }
            if (compareTo == 0) {
        ...
        while (i11 <= i10) {
            int i12 = (i11 + i10) / 2;
            int compareTo2 = k10.compareTo((Comparable) ((zzmn) this.zza[i12]).getKey());
            if (compareTo2 < 0) {
                i10 = i12 - 1;
            } else {
                if (compareTo2 <= 0) {
    ...
    public final V zzb(int i10) {
        zzg();
        V v10 = (V) ((zzmn) this.zza[i10]).getValue();
    ...
    public boolean equals(Object obj) {
        ...
        if (i10 != zzmjVar.zzb) {
            obj2 = entrySet();
            obj3 = zzmjVar.entrySet();
        } else {
            for (int i11 = 0; i11 < i10; i11++) {
                if (!zza(i11).equals(zzmjVar.zza(i11))) {
                    return false;
                }
            }
            if (i10 == size) {
    ...
    public final V zza(K k10, V v10) {
        zzg();
        int zza = zza((zzmj<K, V>) k10);
        if (zza >= 0) {
            return (V) ((zzmn) this.zza[zza]).setValue(v10);
        }
        zzg();
        if (this.zza == null) {
        ...
        this.zza[i10] = new zzmn(this, k10, v10);
        this.zzb++;
        return null;
    }
