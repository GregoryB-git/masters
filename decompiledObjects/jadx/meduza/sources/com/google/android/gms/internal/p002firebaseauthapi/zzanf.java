    ...
    public final String zza(byte[] bArr, int i10, int i11) {
        ...
        while (i10 < i12) {
            ...
            if (b11 >= 0) {
                ...
                zzand.zza(b11, bArr[i15], cArr, i14);
                i10 = i15 + 1;
                i14++;
            } else if (b11 < -16) {
                if (i15 >= i12 - 1) {
                ...
                int i17 = i15 + 1;
                zzand.zza(b11, bArr[i15], bArr[i17], cArr, i14);
                i10 = i17 + 1;
                i14++;
            } else {
                if (i15 >= i12 - 2) {
                ...
                byte b13 = bArr[i15];
                int i19 = i18 + 1;
                zzand.zza(b11, b13, bArr[i18], bArr[i19], cArr, i14);
                i10 = i19 + 1;
                i14 = i14 + 1 + 1;
            }
        }
