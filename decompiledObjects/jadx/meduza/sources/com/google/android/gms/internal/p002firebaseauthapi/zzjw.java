...
public final class zzjw {
    ...
    public static zzju zzb(zzpm zzpmVar) {
        if (!zzpmVar.zza().zzf().equals("type.googleapis.com/google.crypto.tink.HpkePrivateKey")) {
            throw new IllegalArgumentException(f.j("Wrong type URL in call to HpkeProtoSerialization.parseParameters: ", zzpmVar.zza().zzf()));
        }
        try {
    ...
    public static zzjx zzc(zzpn zzpnVar, zzcm zzcmVar) {
        if (!zzpnVar.zzf().equals("type.googleapis.com/google.crypto.tink.HpkePrivateKey")) {
            throw new IllegalArgumentException(f.j("Wrong type URL in call to HpkeProtoSerialization.parsePrivateKey: ", zzpnVar.zzf()));
        }
        try {
    ...
    public static zzkf zzd(zzpn zzpnVar, zzcm zzcmVar) {
        if (!zzpnVar.zzf().equals("type.googleapis.com/google.crypto.tink.HpkePublicKey")) {
            throw new IllegalArgumentException(f.j("Wrong type URL in call to HpkeProtoSerialization.parsePublicKey: ", zzpnVar.zzf()));
        }
        try {
