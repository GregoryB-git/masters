...
public final class i {
    ...
    public static Method f3797b = null;

    /* renamed from: c, reason: collision with root package name */
    public static boolean f3798c = false;

    /* renamed from: d, reason: collision with root package name */
    public static Field f3799d;
    ...
    public static boolean a(View view, KeyEvent keyEvent) {
        ...
        if (Build.VERSION.SDK_INT < 28) {
            ArrayList<WeakReference<View>> arrayList = d0.m.f3780d;
            d0.m mVar = (d0.m) view.getTag(R.id.tag_unhandled_key_event_manager);
            if (mVar == null) {
                mVar = new d0.m();
                view.setTag(R.id.tag_unhandled_key_event_manager, mVar);
            }
            WeakReference<KeyEvent> weakReference = mVar.f3783c;
            if (weakReference == null || weakReference.get() != keyEvent) {
                mVar.f3783c = new WeakReference<>(keyEvent);
                WeakReference<View> weakReference2 = null;
                if (mVar.f3782b == null) {
                    mVar.f3782b = new SparseArray<>();
                }
                SparseArray<WeakReference<View>> sparseArray = mVar.f3782b;
    ...
    */
    public static boolean b(e0.i.a r7, android.view.View r8, android.view.Window.Callback r9, android.view.KeyEvent r10) {
        /*
            r0 = 0
            if (r7 != 0) goto L4
            return r0
        ...
        Lf:
            ...
            e0.i.f3797b = r1     // Catch: java.lang.NoSuchMethodException -> L4a
        L4a:
            e0.i.f3796a = r3
        L4c:
            java.lang.reflect.Method r1 = e0.i.f3797b
            if (r1 == 0) goto L61
        ...
        Le3:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: e0.i.b(e0.i$a, android.view.View, android.view.Window$Callback, android.view.KeyEvent):boolean");
    }
}
