...
public final class v extends AbstractC1108x implements P {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f18406a[AbstractC1108x.d.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f18406a[AbstractC1108x.d.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f18406a[AbstractC1108x.d.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f18406a[AbstractC1108x.d.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f18406a[AbstractC1108x.d.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f18406a[AbstractC1108x.d.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class b extends AbstractC1108x.a implements P {
        ...
        public b y(AbstractC1093h abstractC1093h) {
            s();
            ((v) this.f11542p).e0(abstractC1093h);
            return this;
        }

        public b z(x xVar) {
            s();
            ((v) this.f11542p).f0(xVar);
            return this;
        }
    ...
    public static v d0(AbstractC1093h abstractC1093h, C1101p c1101p) {
        return (v) AbstractC1108x.K(DEFAULT_INSTANCE, abstractC1093h, c1101p);
    }
