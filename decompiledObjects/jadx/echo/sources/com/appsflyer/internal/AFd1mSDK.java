...
public final class AFd1mSDK extends AFd1zSDK<DeepLinkResult> {
    ...
    public final AFd1ySDK valueOf() {
        ...
        return AnonymousClass2.values[AFLogger.getStatus().ordinal()] != 1 ? this.afDebugLog.getError() == DeepLinkResult.Error.TIMEOUT ? AFd1ySDK.TIMEOUT : AFd1ySDK.FAILURE : AFd1ySDK.SUCCESS;
    }
}
