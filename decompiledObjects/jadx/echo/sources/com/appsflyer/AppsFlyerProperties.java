...
public class AppsFlyerProperties {
    ...
    public String getReferrer(AFb1dSDK aFb1dSDK) {
        ...
        return str != null ? str : getString("AF_REFERRER") != null ? getString("AF_REFERRER") : aFb1dSDK.values("referrer", (String) null);
    }
            ...
            if (values != null) {
                ...
                try {
                    ...
                    for (int i7 = 0; i7 < 3; i7++) {
                        this.AFInAppEventType.remove(strArr[i7]);
                    }
    ...
    public synchronized void set(String str, int i7) {
        this.AFInAppEventType.put(str, Integer.toString(i7));
    }
    ...
    public synchronized void set(String str, long j7) {
        this.AFInAppEventType.put(str, Long.toString(j7));
    }
    ...
    public synchronized void set(String str, boolean z7) {
        this.AFInAppEventType.put(str, Boolean.toString(z7));
    }
