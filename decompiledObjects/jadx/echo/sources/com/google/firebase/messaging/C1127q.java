...
public class C1127q implements Application.ActivityLifecycleCallbacks {

    /* renamed from: o, reason: collision with root package name */
    public final Set f11812o = Collections.newSetFromMap(new WeakHashMap());
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        ...
        if (intent == null || !this.f11812o.add(intent)) {
            return;
        }
    ...
    public void onActivityPaused(Activity activity) {
        if (activity.isFinishing()) {
            this.f11812o.remove(activity.getIntent());
        }
    }
