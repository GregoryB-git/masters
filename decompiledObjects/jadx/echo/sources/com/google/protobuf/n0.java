...
public interface n0 {
    ...
    void J(int i7, List list, Z z7);

    void K(int i7, List list, Z z7);

    void L(int i7, Object obj, Z z7);

    void M(int i7, AbstractC1141f abstractC1141f);

    void N(int i7, Object obj, Z z7);

    void O(int i7, D.a aVar, Map map);
