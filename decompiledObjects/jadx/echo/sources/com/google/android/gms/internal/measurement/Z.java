...
public enum Z {
    ...
    public static final Map f10743D0 = new HashMap();
    ...
    static {
        for (Z z7 : values()) {
            f10743D0.put(Integer.valueOf(z7.f10804o), z7);
        }
    }
    ...
    public static Z c(int i7) {
        return (Z) f10743D0.get(Integer.valueOf(i7));
    }

    @Override // java.lang.Enum
    public final String toString() {
        return Integer.valueOf(this.f10804o).toString();
    }
}
