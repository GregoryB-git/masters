...
public abstract class q0 {
    ...
    public static final class e extends b {
        ...
        */
        ...
        public static int h(byte[] bArr, int i7, long j7, int i8) {
            ...
            if (i8 == 1) {
                return q0.j(i7, p0.s(bArr, j7));
            }
            if (i8 == 2) {
                return q0.k(i7, p0.s(bArr, j7), p0.s(bArr, j7 + 1));
            }
        ...
        public String a(byte[] bArr, int i7, int i8) {
            ...
            while (i7 < i9) {
                int i12 = i7 + 1;
                byte s8 = p0.s(bArr, i7);
                if (a.n(s8)) {
                    int i13 = i11 + 1;
                    a.i(s8, cArr, i11);
                    while (i12 < i9) {
                        byte s9 = p0.s(bArr, i12);
                        if (!a.n(s9)) {
                            break;
                        }
                        i12++;
                    ...
                    int i14 = i7 + 2;
                    i7 += 3;
                    a.j(s8, p0.s(bArr, i12), p0.s(bArr, i14), cArr, i11);
                    i11++;
                } else {
                    if (i12 >= i9 - 2) {
                        throw C0778z.c();
                    }
                    byte s10 = p0.s(bArr, i12);
                    int i15 = i7 + 3;
                    byte s11 = p0.s(bArr, i7 + 2);
                    i7 += 4;
                    a.h(s8, s10, s11, p0.s(bArr, i15), cArr, i11);
                    i11 += 2;
                }
            }
            return new String(cArr, 0, i11);
            ...
            while (i10 < length) {
                ...
                if (charAt2 >= 128 || j10 >= j11) {
                    if (charAt2 >= 2048 || j10 > j11 - 2) {
                        ...
                        if ((charAt2 >= 55296 && 57343 >= charAt2) || j10 > j11 - 3) {
                            ...
                            if (i11 != length) {
                                ...
                                if (Character.isSurrogatePair(charAt2, charAt3)) {
                                    ...
                                    j8 = 1;
                                    p0.H(bArr, j10, (byte) ((codePoint >>> 18) | 240));
                                    j9 = j11;
                                    p0.H(bArr, j10 + 1, (byte) (((codePoint >>> 12) & 63) | 128));
                                    long j12 = j10 + 3;
                                    p0.H(bArr, j10 + 2, (byte) (((codePoint >>> 6) & 63) | 128));
                                    j10 += 4;
                                    p0.H(bArr, j12, (byte) ((codePoint & 63) | 128));
                                    i10 = i11;
                                } else {
                                    i10 = i11;
                                }
                        ...
                        p0.H(bArr, j10, (byte) ((charAt2 >>> '\f') | 480));
                        long j13 = j10 + 2;
                        p0.H(bArr, j10 + 1, (byte) (((charAt2 >>> 6) & 63) | 128));
                        j10 += 3;
                        p0.H(bArr, j13, (byte) ((charAt2 & '?') | 128));
                    } else {
                        str = str3;
                        str2 = str4;
                        long j14 = j10 + j7;
                        p0.H(bArr, j10, (byte) ((charAt2 >>> 6) | 960));
                        j10 += 2;
                        p0.H(bArr, j14, (byte) ((charAt2 & '?') | 128));
                    }
                    j9 = j11;
                    j8 = 1;
                } else {
                    p0.H(bArr, j10, (byte) charAt2);
                    j9 = j11;
                    str2 = str4;
                    j8 = j7;
                    j10 += j7;
    ...
    public static boolean m(byte[] bArr) {
        return f9070a.c(bArr, 0, bArr.length);
    }

    public static boolean n(byte[] bArr, int i7, int i8) {
        return f9070a.c(bArr, i7, i8);
    }
}
