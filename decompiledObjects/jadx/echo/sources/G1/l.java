...
public final class l {
    ...
    public static final class a implements InvocationHandler {
        ...
        /* renamed from: b, reason: collision with root package name */
        public final /* synthetic */ u f2061b;

        /* renamed from: c, reason: collision with root package name */
        public final /* synthetic */ ReentrantLock f2062c;

        /* renamed from: d, reason: collision with root package name */
        public final /* synthetic */ Condition f2063d;

        public a(Object obj, u uVar, ReentrantLock reentrantLock, Condition condition) {
            this.f2060a = obj;
            this.f2061b = uVar;
            this.f2062c = reentrantLock;
            this.f2063d = condition;
        }
        ...
        public Object invoke(Object obj, Method method, Object[] objects) {
            ...
            try {
                    ...
                    if (obj2 instanceof List) {
                        for (Object obj3 : (List) obj2) {
                            if (obj3 != null) {
                                ...
                                if (method2.invoke(obj3, new Object[0]) == null && Intrinsics.a(method3.invoke(obj3, new Object[0]), this.f2060a)) {
                                    ...
                                    this.f2061b.f16230o = new BigInteger(1, (byte[]) invoke).toString(16);
                                    this.f2062c.lock();
                                    try {
                                        this.f2063d.signalAll();
                                        return null;
                                    } finally {
                                        this.f2062c.unlock();
                                    }
                ...
                Log.d(l.f2058b, "Can't fetch checksum.", th);
            }
            return null;
        }
    }
    ...
    public static final String c(Context context, Long l7) {
        ...
        try {
            ...
            Object newProxyInstance = Proxy.newProxyInstance(l.class.getClassLoader(), new Class[]{cls}, new a(obj, uVar, reentrantLock, newCondition));
            ...
            method.invoke(context.getPackageManager(), context.getPackageName(), Boolean.FALSE, obj, w.I(I6), newProxyInstance);
            if (l7 == null) {
                newCondition.await();
            } else {
                newCondition.awaitNanos(l7.longValue());
            }
            String str2 = (String) uVar.f16230o;
