...
public abstract class i {
    ...
    public static String a(CharSequence charSequence, int i7) {
        return b(charSequence, 0, charSequence.length(), i7);
    }

    public static String b(CharSequence charSequence, int i7, int i8, int i9) {
        int i10;
        int i11;
        int i12 = 0;
        while (true) {
        ...
        for (int i14 = i7; i14 < i7 + i8; i14++) {
            ...
            while (i15 > 0) {
                if (charAt == 0 || (i11 = iArr2[i15]) == 0) {
                    cArr[i15] = cArr[i15 - 1];
                } else {
                    char c7 = cArr[i15 - 1];
                    int[] iArr3 = f9994d;
                    int[] iArr4 = f9993c;
                    cArr[i15] = (char) (iArr3[(iArr4[charAt] + iArr4[i11]) % 255] ^ c7);
                }
                i15--;
            }
            if (charAt == 0 || (i10 = iArr2[0]) == 0) {
                cArr[0] = 0;
            } else {
                int[] iArr5 = f9994d;
                int[] iArr6 = f9993c;
                cArr[0] = (char) iArr5[(iArr6[charAt] + iArr6[i10]) % 255];
            }
        }
    ...
    public static String c(String str, k kVar) {
        ...
        if (f7 == 1) {
            ...
            while (i7 < f7) {
                ...
                iArr3[i7] = 0;
                if (i7 > 0) {
                    iArr3[i7] = iArr3[i7 - 1] + iArr[i7];
                }
                i7 = i8;
            }
            for (int i9 = 0; i9 < f7; i9++) {
                StringBuilder sb2 = new StringBuilder(iArr[i9]);
                for (int i10 = i9; i10 < kVar.a(); i10 += f7) {
                    sb2.append(str.charAt(i10));
                }
                String a7 = a(sb2.toString(), iArr2[i9]);
                int i11 = i9;
                int i12 = 0;
                while (i11 < iArr2[i9] * f7) {
                    sb.setCharAt(kVar.a() + i11, a7.charAt(i12));
                    i11 += f7;
                    i12++;
                }
            }
